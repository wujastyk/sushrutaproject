...
Here, there are, in brief, fifteen ways of mending the ear flap.\footnote{The Nepalese version uses the word \emph{sandhāna} to refer to joining a split in an ear flap, which is consistent with the terminology in the verse cited above (8). However, the vulgate uses the term \emph{bandha} here and at the very beginning of the chapter (1.16.1) to introduce the topic of repairing the ear.}  They are as follows:
    ...
    amount of \se{kṣīṇa}{wasted} flesh and it will not grow.\footnote{In his 1938 edition of \emph{Suśrutasaṃhitā}, Ācārya includes in parentheses the following treatment for these conditions, which according to a footnote is not found in the palm-leaf manuscript he used \citep[79 n. 1]{susr-trikamji3}: 'One should sprinkle it with raw sesame oil for three days and one should renew the cotton bandage after three days' (\emph{āmatailena trirātraṃ pariṣecayet trirātrāc ca picuṃ parivartayet}).}
    ...
    white mustard oil. \footnote{The vulgate (SS 1.16.19 includes \se{sarpis}{ghee}. However, both Ḍalhaṇa and Cakrapāṇi appear to have been aware of a version (perhaps, similar to the Nepalese one) that does not. Ḍalhaṇa notes that others read simply four oils and not milk, whereas Cakrapāṇi says some read that it is made with milk and four oils.} %  
...
Then cook the oil with an \se{prativāpa}{admixture} of the following:
    ...
    \plant{`milk flower'}{payasyā  $\rightarrow$ vidārī}{Pueraria tuberosa (Willd.) 
        ...
        451, IMP 1.187, but IMP 3.1719 = Ipmoea mauritiana, Jacq.}.\footnote{The vulgate (SS. 1.16.19) adds several ingredients to this admixture, including \emph{apāmārga, aśvagandhā, kṣīraśuklā, madhuravarga} and \emph{payasyā}. Also, it has \emph{vidārigandhā} instead of \emph{vidāri}. When commenting on this passage, Ḍalhaṇa notes that some do not read \emph{madhuravarga} and \emph{payasyā}. Therefore, there were probably other versions of this recipe with fewer ingredients, as seen in the Nepalese version.}
    %

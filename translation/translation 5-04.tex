...
\se{sarpita}{serpented}, \se{darita}{torn} and thirdly \se{nirviṣa}{without
    venom}.  Some experts want to add “hurt by the snake's body.”

\item[15]

The physician can tell he has been \se{sarpita}{serpented} as follows. 
There are one, two or more depressed \se{pada}{locations} of the teeth.  And
it makes a swelling.\footnote{Ungrammatical phrase.}  They have a line of
    \se{cuñcu}{puncture-marks},\footnote{The usual dictionary lexeme is
        \dev{cañcu} “beak, billl,” not \dev{cuñcu}, but the Nepalese manuscripts are

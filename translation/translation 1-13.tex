...
First of all, get the patient who has an ailment that is treatable
by leech-bloodletting to sit or lie down.  Then, dry any site that has a
wound with powders of earth and cow-dung.  Then make them free from
impurities, with their limbs smeared with \gls{sarṣapa} and \gls{rajanī} and
moving about in the middle of a cup of water. After all this, make them
attach to the ailment.  Now, for those that are not attaching, add a drop of
milk or a drop of blood.  Alternatively, make incisions.  And if it still
will not attach, make other ones attach.

\item [20]
 
One can know that it is attached when it moves in, hunching its shoulders and

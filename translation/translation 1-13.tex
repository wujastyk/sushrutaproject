...
water. Traditionally, they do not behave in a confused manner or lie in the
mud.\footnote{Ḍalhaṇa on \Su{1.13.14}{57} explains \dev{saṅkīrṇacārin},
    “behaving in a confused manner” as \dev{viṣādiviruddhāhārabhujaḥ}  that
    presumably means that they do not eat unwholesome foods like poisons.  Cf.\
    Ḍalhaṇa's gloss of \dev{viruddha} as \dev{ahita} at \Su{4.23.4}{485}.}
\end{sloka}

\item[15]

They can be grasped with a fresh hide or in other ways.\q{Ḍalhaṇa?}

Having grasped them, 

\item [16]
then these should be put into a large new pot furnished with mud and the water from 
lakes or wells. One should provide what they need to eat.  After grinding up 
\gls{śevāla}, \gls{vallūra}, and aquatic roots, every three days one should give 
them grass to lie on, aquatic leaves  water food.\q{jalabhakta}  Every week, one 
should make them crawl into a different pot. 

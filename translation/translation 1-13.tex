...
are injured,\footnote{\emph{Pace} Ḍalhaṇa on \Su{1.13.18}{57} who
    glosses \dev{amanojñadarśana} as “nasty looking.”} or \diff{thin}, those
    that are not born in the proper habitat, those that will not attach, that
    drink little or those that are venomous.
\end{sloka}

\item[19] First of all, get the patient who has an ailment that is treatable
...
moving about in the middle of a cup of water. After all this, make them grip
the ailment.  Now, if they do not grip, add a drop of milk or a drop of
blood.  Alternatively, make incisions.  Or, if 

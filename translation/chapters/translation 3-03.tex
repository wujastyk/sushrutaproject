...
concur and differ from the view expressed in the \CS.}
...
that".\footnote{On Pārāśarya, see \volcite{1A}[174 et passim]{meul-hist}A
    Once again, this person is associated with a different view in the 
    \emph{Bhelasaṃhitā}.}
    
 “\diff{Breath} that is the hand and foot,” says Mārkaṇdeya, “because they are 
 the root of its motion”.\footnote{Manuscript H has the word \dev{prāṇa} that is 
 not present in the vulgate; it is hard to construe except as a noun in apposition 
 to the dvandva “hand and foot.''  }

...
When a woman, \se{dauhṛda}{when sharing her heart with the fetus}, is
slighted in respect of one of the objects of sense, she will bring
forth a son who suffers pain in that selfsame sense
organ.\footnote{Note the historical confusions of \dev{dauhṛda},
    \dev{dohada} \dev{daurhṛda} and \dev{dvi-hṛd}.}
    
    \item [22]
   
   A woman who has a \se{dauhṛda}{pregnant longing} to see a king gives birth 
   to a son who is wealthy and very fortunate.  
    
\item[23]

A woman who is \se{dauhṛdā}{sharing her heart with the fetus},
in fine raiment, undergarments, silk and decoration, 
...
is like one who gives joy.\footnote{The reading of the vulgate,
    \dev{pārṣada-} for the Nepalese \dev{harṣada-}, makes better sense:
    “is like an attendant."}

If she is within sight of wild species of animal then she gives birth to one who with 
violent habits. 

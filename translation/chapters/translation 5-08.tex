...
\diff{authoritative} origin of spiders,\footnote{The vulgate's reading
    ...
    manuscripts.} and in a general way the incurable and curable bitten
    patient as well as the therapy and the \diff{distinctions to be
        made}.\footnote{The vulgate reads \dev{yathāviśeṣam} “according to
        their specifics,” qualifying the therapies.  The Nepalese version's
...
sages, angry. Drops of sweat from that angry sage's forehead, as
brilliant as the sun because of his countenance, reached the grass
that had been cut (“\emph{lūna}”) and gathered by the sage for his
...
were sixteen in number.
 ...
 that are hard to treat, and exactly the same number that should be avoided.

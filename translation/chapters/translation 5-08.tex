...
\se{koṭha}{hives};\footnote{On the translation “hives” see
    note \ref{kotha}.} 
    
    There are said to be six kinds of \gls{pipīlika}: 
    \begin{itemize}
        \item \gls{saṃvāhikā}, 
        ...
        \item \gls{kapilā}.    
    \end{itemize}
If one is bitten by one of them there is pain, burning and itchy swelling

\item[34 v.\,1]  % pipīlikas

There are said to be six \glspl{pipīlika},  \Gls{vivarṇā}
and \Gls{kapilā}.\footnote{Note the marginal insertions in both
    ...
    manuscripts. } When bitten by these, there is painful burning as well
    as itchy swelling.\footnote{Or “pain and burning as well as itching
        ...
        recoverable text is disturbed here.}
...
There is pain; blood with much \se{rāga}{red colour}, accompanied by itching, 
flows out.\footnote{This passage in both Nepalese witnesses is is not in the 
vulgate.  There are three preceding passages in witness H that are not present in K, 
and are not translated here.  They are somewhat corrupted and appear to treat of 
\glspl{makṣika} and \glspl{maśaka}.}


\footnote{This appears to be part of a description of makṣikas.}

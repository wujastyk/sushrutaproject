...
\se{kīṭa}{insects}:
\begin{itemize}
    \item \se{śvetaś}{White},
    \item \se{kṛṣṇavarṇa}{Black-coloured},
    \item \se{śaravarṇa}{Arrow-coloured},
    \item \se{aprabha}{Lustreless},
    \item \se{kuhara}{Cavity},
    \item \se{harita}{Greenish},
    \item \se{bhṛkuṭī}{Frown},
    \item \se{koṭika}{Little Point}.
\end{itemize}
Someone bitten by one of them gets itchy, greenish, faint and 
vomits.\footnote{\Dalhana{5.8.31}{588} quoted a passage from “another book” 
(not the \CS) that described frogs as follows: “When it rains, during the rainy 
season, a great snake may discharge semen.  Then, when autumn comes, the water 
has froth (\emph{maṇḍu}).  In that frothy water, frogs (\emph{maṇḍūka}) are 
born, which is why they are called that.  Experts say that a frog walks like a cow 
(\emph{gogati}) so it is called a \emph{koṭika}.  It's bite kills; there is no 
countermeasure against it.”}

\item[31 add]

Six leeches are described, with their characteristics and 
...
vulgate.}
\begin{itemize}
    \item \se{ahikuttha}{Snake-sore},
    \item \se{kutthuka}{Sore-maker}, and the
    \item \se{vṛttaśūka}{Round-bristle}.\footnote{The English translations are 
...
Three \Glspl{viśvambhara} are described, that bring burning, fever and
pain.\footnote{Breaking the pattern of these descriptions, the names
    ...
    bite.\footnote{The next passage in the vulgate sequence,
        \Su{5.8.33}{588}, describes an animal called \emph{Ahiṇḍukā}.  This
        ...
        symptoms of being bitten by Ahiṇḍukās, Kaṇḍūmakas and Śūkavṛntās,
        ...
        and the others, because they need to be treated separately.”) }
...
There are said to be six \glspl{pipīlika},  \se{vivarṇṇā}{colourless}
and \se{kapilā}{brown}.\footnote{Note the marginal insertions in both
    MSS K and H, the latter attributed to \dev{granthāntare} “in another
    book.” The scribe of H was aware of variant readings in other manuscripts.}
    When bitten by these, there is painful burning as well as itchy 
    swelling.\footnote{Or “pain and burning as well as itching and swelling” if these
        are grammatically relaxed dvandvas.}
    
%    When bitten by one
%    of them, there is sharp pain, swelling at the circle of the bite.

...
the Uttaratantra I shall explain the topics that have been referred to here but 
not explained.\footnote{There now follow six verses that are present in the 
Nepalese version, but not in the vulgate.}

\item[140 add 1]

The \emph{Ślokasthāna} describes, concisely in sūtra form, the discipline, the 
origin of 
the discipline, the strengths and weaknesses of the treatments for diseases
...
the definition of the stages.\footnote{\dev{avasthā} “stages” here
    probably refers to degrees of affliction, although this is not a
    distinct section of the \emph{Nidānasthāna}.} %\footnote{The reference
    % to
    % \dev{avasthā} may point to

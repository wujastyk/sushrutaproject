...
These are the twelve terrible ones that are born of all three humours.\footnote{Two
    verses appear at this point in the vulgate that are not in the
    Nepalese version.  They describe the treatment with caustics of especially 
    painful bites that combine all three humours and added symptoms of bites 
    according to the humour affected.}
...
From here onwards the subdivisions of each class of insects will be explained.

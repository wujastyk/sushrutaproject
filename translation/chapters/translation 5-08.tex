...
Therefore, its special progress cannot be opposed, just as the progress of a 
strong king cannot be stopped when he is in his own land.
 
\item[143 add 4]

The \emph{Uttaratantra} is stated for the purpose of treating such ailments as 
fever. It is a teaching about complications, etiology, and symptoms.
...
\begin{quote}
    Someone who reads this work that is recorded in five sections with one 
    hundred and twenty chapter, together with the \se{uttara}{latter part}, is 
    worthy of a king and revered by physicians. He is a doctor who has acquired 
    the steps for applying therapy.
\end{quote}

\item [143 add 6]

Protection of food, stationary and moving poisons, the toxicology of snakebite 
patients, the treatment of snakebite patients, rats, the drum, and with the 
treatment of insects as the eighth. 

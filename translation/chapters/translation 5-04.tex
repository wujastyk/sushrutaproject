...
layers\sse{kalā}{layer} of skin that come into existence during embryonic
development or seven interstitial tissues that separate the various parts
of the body.\footnote{\label{ka4:kalā}The system of the \dev{kalā} is
...
commenting on
    \AH\ \Ah{1.16.17}{246}, glossed \dev{kalpa} as \dev{prayoga}.}
...
by one causes the \se{vega}{toxic pulse}.\footnote{See note \ref{ka4:kalā}
    above.}
\end{sloka}

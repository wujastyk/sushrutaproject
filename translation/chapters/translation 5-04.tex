...
with rough skin and different colours.\footnote{Presumably “different”
    ...
    Following sequence of three verses is slightly different from the
...
\begin{enumerate}
    \raggedright
    \item The Black snake;
    \item The Big Black;
    \item The Black Belly;
    \item The All Black;
    \item The White;
    \item The Pigeon;
    \item The Rain Cloud;
    \item The Great Snake;
    \item The Conch Keeper;
    \item The Red Eye;
    \item The Gavedhuka;
    \item The Snake Around;
    \item The Break Hood;
    \item The Kūkuṭa;
    \item The Lotus;
    \item The Great Lotus;
    \item The Variegated Flower Sprinkle Beauty;
    \item The Mountain Snake;
    \item The Strait Snake;
    \item The White Rip;
    \item The Big Head;
    \item and The Hungry Sting.
    \end{enumerate}
\end{multicols}

...
The Vaikarañjas originate out of conflictiual unions amongst the three classes. 
Thus:
...
\item The \se{poṭagala}{Poṭagala}; 
\item The \se{snigdharāji}{Oily Streak}; 
\end{enumerate}
%\end{multicols}

In that context, \se{mākuli}{Mākuli};  is born by the mating of a male Black 
Snake and a female \se{gonasa}{Cow Snout}, or the reverse.\q{vaiparītena, 
vaiparītyena}  The \se{poṭagala}{Poṭagala} is born by the mating of a Rājila in a 
\se{gonasa}{Cow Snout} or the reverse.  The \se{snigdharāji}{Oily Streak} is 
born by the mating of a male Black Snake and a Rājimat, or the reverse. Their 
poison is like that of their father, because of the eminence out of the two; but 
others say it is like the mother.   Thus eighty of these snakes have been 
described.

\item[34]
\item[35]
Amongst them, males have large eyes, tongues and heads.  Females have small 
eyes, tongues and heads. Neuters have both characteristics, and are slow to 
exert themselves or be angry.

\item[36]
In that context we shall give general instruction  about the signs of having been 
bitten by any of the snakes. 

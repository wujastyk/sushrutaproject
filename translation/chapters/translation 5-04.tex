...
All snakes that are variegated (Rājīmants) move about during the first watch
of the night.  The rest, on the other hand, the Maṇḍalins and the
Darvīkaras, are diurnal.\footnote{The readings of the vulgate, that Rājimants are 
...
Here are the Vaikarañjas.

\begin{multicols}{2}
    \begin{enumerate}
        \raggedright
\item \se{mākuli}{The Mākuli}; 
\item \se{poṭagala}{The Poṭagala}; 
\item \se{snigdharāji}{}; 
%\item \se{kṛṣṇasarpeṇa}{}; 
%\item \se{gonasyāṃ}{}; 
%\item \se{vaiparītena}{}; 
%\item \se{jāto}{}; 
%\item \se{mākuli}{};\footnote{Duplicate.}
%\item \se{rājilena}{}; 
%\item \se{gonasyāṃ}{}; 
%\item \se{vaiparītyena}{}; 
%\item \se{jāta}{}; 
%\item \se{poṭagala}{};\footnote{Duplicate.}
\end{enumerate}
\end{multicols}

...
\cite{birc-2021,wuja-2013b,wuja-root3,wuja-2003}
...
literature.\footnote{The idea seems to be that there is no time to
    ...
    singled out as one of Āyurveda's virtues in \Su{5.8.142}{594}. Alternatively, 
    perhaps the patient is unable to understand what the doctor is saying to him.} 
    % got to
    % here 2023-10-25
...
and the bitemark to be black; there is driness, the joints hurt and the head feels 
heavy; 
the waist, back and neck feel week; there is yawning, the voice becomes faint, 
his throat rattles, there is paralysis, dry throat, cough, wheezing, 
and hiccups.  The wind goes upwards, the patient convulses with sharp pain, 
black saliva dribbles out, foam appears, the ducts are blocked and there is every 
kind of pain due to wind.
%\footnote{The grammar of “\sed{sroto 'varodhas}{the 
%ducts are blocked}” looks like external sandhi applied inside a compound.}

The poison of a Maṇḍala, on the other hand, causes the skin, nails, eyes, teeth, 
mouth, urine, feces, bitemark  to be yellow; there is a desire for cold, smoking 
heat,\footnote{The term “\sed{paridhūpāyana}{smoking heat}” is not in 
\cite[596]{moni-sans} as such, although \dev{paridhūpana, paridhūmana and 
paridhūmāyana} are cited and referred to the \SS.  \sed{paridhūpana} is listed 
at \SS\ \Su{2.6.13}{291} amongst the symptoms of urinary disease caused by 
phlegm. The editors note a variant reading 
\dev{paridhūmāyana} but do not tell us in which manuscript \citep[291, 
n.\,3]{vulgate}. \Dalhana{2.6.13}{292} glossed the term as 
“\sed{samantatas tāpaḥ}{hot all over}” and in our current passage as
“\sed{sarvāṅgasantāpaḥ}{hot over the whole body}” (\cite[573]{vulgate}).  See 
also \volcite{1}[429]{josi-maha}: \dev{dhūmāyana} “\dev{aṅgānāṃ 
dhūmodvamanamiva}” citing the \SS.}
a burning feeling, thirst, intoxication, fainting, fever, the appearance of blood, 
and the sagging down of flesh and fat above and below. There is swelling, 
suppuration of the bite, confused vision, the patient is angry and every kind of 
pain due to bile.

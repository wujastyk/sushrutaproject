...
pulses}.\footnote{Cf.\ the same concept in the context of plants, at 
...
\se{dhātu}{bodily tissues}.  Poison passing through these one by one  
causes the \se{vega}{toxic pulse}.\footnote{The seven layers of skin
    are discussed at XXX}\q{kalā doctrine; see SS śārīra 4.4}
\end{sloka}
...
broods.\footnote{The verb \root\dev{pradhyai} ”meditate, be
    thoughtful, brood” is unexpected here and in the  second
    class, an epic form. \Dalhana{5.4.42}{574} noted a variant reading that
    omitted the vulgate's variant \dev{dhyāyati prathame} “at first it
    broods.”}\q{check in epic sanskrit}
...
\begin{sloka}
    ...
    pulse}.\footnote{On \dev{antaḥsveda} as “elephant,” see Arthaśāstra 
    09146}\q{clear up AS reading}
...
single \se{vega}{toxic pulse} and that amongst animals like cats and

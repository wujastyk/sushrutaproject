...
interestingly coordinated with the \SS's concept of the 
\emph{kalā}s,\sse{kalā}{membrane}
which are either seven skin-like membranes that come into
...
body.\footnote{\label{ka4:kalā}The system of the \dev{kalā} is
    ...
    \SS's concept of seven membranes appears in later works such as the
...
\begin{multicols}{2}
 ...
 \item \se{tatra}{The Tatra};\protect\footnote{This seems implausible, but 
 otherwise the 
 list of Maṇḍalins would be short.} 
 \item \se{citraka}{The Mark}; 
 \item \se{eṇīpada}{The Deer Foot}.\protect\footnote{The list is short by
...
\item \se{darbhapuṣpa}{The Grass Flower};\protect\footnote{Also in the 
Darvīkara 
list.}  
\item \se{lohitākṣa}{The Red Eye};\protect\footnote{Also in the Darvīkara 
    list.}  
...
\begin{sloka}
    \label{ka4:kalā-vega}
It is well known that there are seven \sepl{kalā}{membrane} in

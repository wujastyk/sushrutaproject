...
snakes.\footnote{The first edition of Fayrer's work was published two
    ...
    illustrations.\footnote{Calling his work a supplement to
        ...
        fright (see \ref{fright} below). \citet{wall-1921} provided a wealth of detail 
        of the snakes
...
swelling.\footnote{\label{fright}\citep[69]{wall-1913} remarked on the difficulty 
of separating
    toxicity symptoms from the psychosomatic effects of terror:\begin{quote}
        ...
        country.\end{quote}. Wall went on to give several case studies in which 
...
eagles,\footnote{Ḍalhaṇa on \Su{5.4.21}{571} identified the \dev{suparṇa}
    ...
    514]{dave} too noted that it may refer to the Garuḍa, but more clearly in
    some contexts to the Golden Eagle, Golden Oriole, Lammergeyer, etc.
    \citet[199\,ff, 492]{dave} noted again that the Garuḍa is a mythical bird
    but may refer to the Himalayan Golden Eagle and other species of eagle.
    \citet[201]{dave} pointed out that historically, “The original physical
    basis for \dev{garuḍa} as the \dev{nāgāśī} (snake-eater) was most
    probably the Sea-Eagle who picks up sea-snakes from the sea or sand-beach
    and devours them on a nearby tree\ldots.” Dave continued with interesting
    reference to Śrīharṣa's \emph{Nāgānanda}.} gods, holy sages,
    \diff{spirits}, and saints, or in places full of herbs that destroy
    poison.\footnote{For “spirits” the Nepalese version has \dev{bhūta} while
        the vulgate reads \dev{yakṣa}.}
...
decorated with many kinds of circles. % as flaming fire.  

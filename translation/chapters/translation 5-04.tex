...
\se{stiffness of the neck}{manyāstambha} and heaviness of the head.
...
\begin{sloka}
    It is well known that there are seven \se{kalā}{layers of skin} in between the 
\se{dhātu}{bodily tissues}.  Poison enters into these one by one and causes the 
\se{vega}{toxic pulse}.
\end{sloka}
...
\item[41]
\begin{sloka}
The interval taken by the \se{kālakalpa}{deathly substance}, \se{\root
    ūh}{propelled} by air, to cut the \se{kalā}{layers of skin} is
traditionally called the “\se{vegāntara}{pulse
...
broods.\footnote{The verb \root\dev{pradhyai} ”meditate, be
    thoughtful, brood” is unexpected here.  \Dalhana{5.4.42}{574} noted a
    variant reading that omitted the vulgate's variant \dev{dhyāyati
    prathame} “at first it broods.”}
...
necks.\footnote{The scribe of MS H emended the text to read
    ...
    \dev{bhañj}.}  In the fourth, the bewildered creature trembles and grinding 
...
\item[44--45]
\begin{sloka}
    Some experts say there are three toxic pulses\sse{vega}{toxic pulses}, in the 
    intermediate divisions.\q{check the MSS.} 
    
    So, at the first pulse, a bird becomes bewildered and is confused
from that point on.  At the second, the bird is distressed and,
crying out, it dies.

Some people claim that where birds are concerned, there is a single toxic
pulse\sse{vega}{toxic pulse}. 

...
\subsection{Notes on Significant Variants}

\begin{enumerate}
	
	\item\label{yogan1} [\ref{yoga}] \textbf{\ldots\dev{dvitīye pāde}\ldots} 
	...
	\item [\ref{padartha}] \textbf{\dev{yatra tu snehasvedābhyañjaneṣu}\ldots\dev{pūrvāparayogasiddho bhavati/}} 
	...
	\item [\ref{padartha}] \textbf{\dev{sāmavedādayaśca vedāḥ/}} 
		Both \SuComma{}{} and the excerpts from the \SS\ cited in the \emph{Jalpakalpataru} read \dev{ṛgvedādayastu vedāḥ},
	 ...
	 \item [\ref{padartha}] \textbf{\ldots\dev{vida vinda ityetayośca dhātvoḥ}\ldots}
 			...
 			\item [\ref{padartha}] \textbf{\ldots\dev{dhātvorekārthaḥ/ paścāt padaṃ bhavati}\ldots}	

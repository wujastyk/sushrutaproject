...
\item [32] Indication pointing to causes on both sides is \se{saṃśaya}{doubt}. For example, a blow to \seEngOnly{talahṛdaya}{'sole-heart'}\footnote{\dev{talahṛdaya} is one of the lethal points mentioned in the \Su{3.6}{}.}  is fatal, whereas cutting hands and feet is not fatal. 

\item [33] An elaborate description is \se{vyākhyāna}{explication}. For example, the twenty-fifth entity \seEngOnly{puruṣa}{person} is being explicated here. Thus, no other Āyurvedic texts discuss  entities beginning with matters. \textit{(Does bhūtādi a compound or it means ahaṅkāra or ego?)}

\item [34] \se{svasaṃjñā}{Field-specific term} is uncommon in other field of studies. The term used in one's own systems is called field-specific term, such as in this system, \seEngOnly{mithuna}{pair} denotes honey and ghee, and \seEngOnly{mithuna}{triad} denotes ghee, sesame oil and fat. 

...
The enumeration and definitions of the \emph{tantrayukti}s in the \emph{Suśruta Saṃhitā} closely parallel their treatment in the \emph{Arthaśāstra}. For a side-by-side comparison of the \emph{tantrayukti}s in the Suśruta Saṃhitā and the Arthaśāstra, please refer to Table \ref{tableSvsA}.


	
\begin{longtable}{m{.25\textwidth} m{.25\textwidth} p{.5\textwidth}}
    
\caption{Tantrayuktis in \emph{Suśruta Saṃhitā} (S) 
    and \emph{Arthaśāstra} (A)} 
    \label{tableSvsA}\\
  	\toprule
    ...
    tadadhikaraṇam/} \\
	(A) 1. & \emph{adhikaraṇa} & \dev{yamarthamadhikṛtyocyate tadadhikaraṇa/} \\
	
	\rule{0pt}{0.5cm}(S) 2. & \emph{yoga} & \dev{yena vākyaṃ yujyate sa yogaḥ/} \\
	(A) 3. & \emph{yoga} & \dev{vākyayojanā yoga/} \\
	
	\rule{0pt}{0.5cm}(S) 3. & \emph{padārtha} & \dev{yo'rtho'bhihitaḥ sūtre pade vā sa padārthaḥ/ padasya padayoḥ padānāṃ vā yo'rthaḥ sa padārthaḥ/ aparimitāśca padārthāḥ/} \\
	(A) 4. & \emph{padārtha} & \dev{padāvadhikaḥ padārthaḥ/} \\
	
	\rule{0pt}{0.5cm}(S) 4. & \emph{hetvartha} & \dev{yaduktaṃ sādhanaṃ bhavati sa hetvarthaḥ/} \\
	...
	\rule{0pt}{0.5cm}(S) 6. & \emph{nirdeśa} & \dev{vistaravacanaṃ nirdeśaḥ/} \\
	...
	\rule{0pt}{0.5cm}(S) 9. & \emph{pradeśa} & \dev{prakṛtasyātikrāntena sādhanaṃ pradeśaḥ/} \\
	(A) 11. & \emph{predeśa} & \dev{vaktavyena sādhanaṃ pradeśaḥ/} \\
	
	\rule{0pt}{0.5cm}(S) 10. & \emph{atideśa} & \dev{/} \\
	(A) 10. & \emph{atideśa} & \dev{uktena sādhanamatideśaḥ/} \\
	
	\rule{0pt}{0.5cm}(S) 11. & \emph{apavarga} & \dev{abhipramṛjyāpakarṣaṇamapavargaḥ/} \\
	(Aa 22. & \emph{apavarga} & \dev{abhiplutavyapakarṣaṇamapavargaḥ/} \\
	
	\rule{0pt}{0.5cm}(S) 12. & \emph{vākyaśeṣa} & \dev{yena padenānuktena vākyaṃ samāpyate sa vākyaśeṣaḥ/} \\
	(A) 17. & \emph{vākyaśeṣa} & \dev{yena vākyaṃ samāpyate sa vākyaśeṣaḥ/} \\
	
	\rule{0pt}{0.5cm}(S) \-\- & \-\- & \-\- \\
	(A) 12. & \emph{upamāna} & \dev{dṛṣṭenādṛṣṭasya sādhanamupamānam/} \\
	
	\rule{0pt}{0.5cm}(S) 13. & \emph{arthāpatti} & \dev{yadakīrtitamarthādāpadyate sārthāpattiḥ/} \\
	(A) 13. & \emph{arthāpatti} & \dev{yadanuktamarthādāpadyate sārthāpattiḥ/} \\
	...
	\rule{0pt}{0.5cm}(S) 15. & \emph{prasaṅga} & \dev{prakaraṇāntareṇa samānaḥ prasaṅgaḥ/} \\
	(A) 15. & \emph{prasaṅga} & \dev{prakaraṇāntareṇa samāno'rthaḥ prasaṅgaḥ/} \\
	
	\rule{0pt}{0.5cm}(S) 16. & \emph{ekānta} & \dev{yadavadhāraṇenocyate sa ekāntaḥ/} \\
	(A) 26. & \emph{ekānta} & \dev{sarvatrāyattamekāntaḥ/} \\
	
	\rule{0pt}{0.5cm}(S) 17. & \emph{anekānta} & \dev{kvacittathā kvacidanyathā so'nekāntaḥ/} \\
	(A)\-\- & \-\- & \-\- \\
	
	\rule{0pt}{0.5cm}(S) 18. & \emph{pūrvapakṣa} & \dev{yastu niḥsaṃśayamabhidhīyate sa pūrvapakṣaḥ/}\footnote{This definition of \emph{pūrvapakṣa} in the Nepalese version is problematic.} \\
	(A) 24. & \emph{pūrvapakṣa} & \dev{pratiṣeddhavyaṃ vākyaṃ pūrvapakṣaḥ/} \\
	...
	\rule{0pt}{0.5cm}(S) 22. & \emph{anāgatāpekṣaṇa} & \dev{evaṃ vakṣyatītyanāgatāpekṣaṇam/} \\
	(A) 27. & \emph{anāgatāvekṣaṇa} & \dev{paścādevaṃ vihitamityanāgatāvekṣaṇam/} \\
	
	\rule{0pt}{0.5cm}(S) 23. & \emph{atikrāntāpekṣaṇa} & \dev{ityuktamityatikrāntāpekṣaṇam/} \\
	(A) 28. & \emph{atikrāntāvekṣaṇa} & \dev{/} \\
	...
	\rule{0pt}{0.5cm}(S) 26. & \emph{svasaṃjñā} & \dev{anyaśāstrāsāmānyā svasaṃjñā/} \\
	...
	\rule{0pt}{0.5cm}(S) 32. & \emph{ūhya} & \dev{yadanirdiṣṭaṃ buddhigamyaṃ tadūhyam/} \\

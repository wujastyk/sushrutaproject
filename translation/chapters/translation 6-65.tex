...
\begin{longtable}{r@{\,}r
	...
	\caption{Tantrayuktis in \SS\  (S), \emph{Viṣṇudharmottarapurāṇa} (V), and
		\emph{Arthaśāstra} (A)} 
	\label{table-SAV}\\
	\toprule
...
Cakrapāṇi defines \emph{adhikaraṇa} in almost the same fashion.\footnote{\dev{yamarthamadhikṛtya pravartate kartā/ yathā “vighnabhūtā yadā rogā”
	ityādi/ atra rogādikam adhikṛtyāyurvedo maharṣibhiḥ kṛta iti ‘rogāḥ’ ityadhikaraṇam/} \parencite[736]{cara-trikamji3}.}
...
Oberhammer and Meulenbeld translate adhikaraṇa as “topic,” and we have adopted the same translation.\footnote{\cite[601]{ober-1967}, \fvolcite{IB}[431]{meul-hist}}. Sharma translates the term as the “scope of the topic.”\footnote{\fvolcite{3}[631]{shar-1999}.}

...
In the \emph{Yuktidīpikā}, these terms are referred to as \emph{tantraguṇa} or \emph{tantrasampat}. They are: (1) \emph{sūtropapatti} (2) \emph{pramāṇopapatti} (3) \emph{avayavopapatti} (4) \emph{anyūnatā} (5) \emph{saṃśayokti} (6) \emph{nirṇayokti} (7) \emph{uddeśa} (8) \emph{nirdeśa} (9) \emph{anukrama} (10) \emph{saṃjñā} and (11) \emph{upadeśa}.\footnote{
	...
	\end{verse}
\cite[3]{wezl-1998}}
Apart from these, the \emph{Yuktidīpikā} also exemplifies (12) \emph{utsarga} (general 
rule), (13) \emph{apavāda} (exception), and (14) \emph{atideśa} (extended application). 
However, \emph{utsarga} and \emph{apavāda} are not considered \emph{tantrayukti}s in 
other comprehensive lists. The \emph{Yuktidīpikā} further states that while other 
\emph{tantrayukti}s can be demonstrated in a similar manner, since they are peripheral 
topics, the text does not delve into their discussion.\footnote{\dev{evamārā anye'pi 
...
while elucidating the concept of \emph{tantraguṇa} (qualities of the system)\footnote{Aruṇadatta on the \AHS\ \Ah{6.40.78}{946}.}  
...
strongly suggests a shared origin.
 ...
 leaving uncertainty about the total number of \emph{tantrayukti}s
  recognized by Dṛḍhabala in this section.\footnote{We know from 
  	...
  	originally authored by Dṛḍhabala, who lived in a town called Pañcanada sometime between 300 and 500 AD. \\Cf. 
	\begin{verse}
...
The commentators who extensively delved into the discussion of the \emph{tantrayukti}s are Hariścandra, the author of \emph{Carakanyāsa}, and Aruṇadatta (12th century),\fvolcite{IA}[663--664]{meul-hist}
...
Aruṇadatta, while discussing the concept of \emph{tantraguṇa} at the end of the \emph{Aṣṭāṅgahṛdaya}, 
...
in the beginning of his commentary, \emph{Hṛdayabodhikā}.\fvolcite{IA}[680]{meul-hist} 
...
However, in the commentaries of Hariścandra and Indu, we explore two more aspects of the concept of \emph{adhikaraṇa}. According to Hariścandra, \emph{adhikaraṇa} is the reason or ground referring to which the authors direct their discourse. For example, diseases create misery and the authors of Āyurveda began their discussion addressing them.\footnote{\dev{tatrādhikaraṇaṃ nāma yannimittamadhikṛtya pravartate kartā/… uta vā
	vighnabhūtā yadā rogāḥ prādurbhūtāḥ tadidaṃ nimittamadhikṛtya jagadanukampayā maharṣibhirayamāyurveda āgamaḥ/ evamadhikaraṇavyākhyā varṇayitavyā/} \MScite{MS Jamnagar GAU 114}, p.4--5.}
...
For illustration, a verse from chapter 18 of the \emph{Cikitsāsthāna} is quoted in the \SS---
...
Aruṇadatta expands its scope to coherence between mention (\emph{uddeśa}) and description (\emph{nirdeśa}) as well.\footnote{\dev{yogo nāma yojanā, uddeśanirdeśayoḥ sūtrabhāṣyayorvā/} \emph{Sarvāṅgasundarī} on \Ah{6.40.80}{947}.}  
...
that padārtha is the referent indicated by a word. 
...
Similar to Arthaśāstra's understanding, the commentators 
Hariścandra, Indu, Cakrapāṇi, Aruṇadatta and Śrīdāsapaṇḍita 
interpret \emph{padārtha} as the referents indicated by a word. 
However, Hariśandra diverges by viewing \emph{padārtha} 
within the framework of Vaiśeṣika philosophy 
listing six types of \emph{padārtha}s: 
\emph{dravya}, \emph{guṇa}, \emph{karman}, \emph{sāmānya}, 
\emph{viśeṣa} and \emph{samavāya}.\footnote{
	\dev{padārtho nāma ya ekena padenānekārtho gamyate/ 
		yathā dravyaṃ guṇaḥ karma sāmānyaṃ viśeṣaḥ samavāyaḥ/}. 
	\MScite{MS Jamnagar GAU 114}, p.6.} 
...
they do not fully endorse the Vaiśeṣika framework.\footnote{
		\dev{padārtho nāma yenārtho gamyate/ 
			yathā gurvādayo guṇaśabdādavagamyate/} \emph{Śaśilekhā} on \As{6.50.150a}{959}.
		\dev{padārtho nāma, padenārtho gamyate/
			yathā dravyamiti padaṃ, tasyārtho bhūjalādiḥ/
			guṇa iti padaṃ tasyārtho gurvādiḥ/} \emph{Sarvāṅgasundarī} on \Ah{6.40.80}{947}.
...
considering \emph{padārtha} as signification or contextual meaning of word.\footnote{
		...
		so'rtho grāhyaḥ/} \emph{Jalpakalpataru} on \fvolcite{3}[3816]{sena-1928}.}
Nīlamegha presents a distinct perspective, 
defining padārtha as polysemy within a given context.\footnote{
	\dev{padārthastu padaikye'pi bhinnamarthaṃ prakāśayet/} \cite[4][4]{muth-1976}.} 
...
that perceives \emph{padārtha} as synonymy within a context.\footnote{
	...
	\cite[5]{muth-1976}.} 
The author of the Tantrayukti merely quoted Nīlamegha's statements on this matter 
...
mentioned in the \emph{Tolkāppiyam}.\footnote{\cite[84]{chev-2009}.}
...
\subsection{\dev{yatra tu snehasvedābhyañjaneṣu}\ldots\dev{pūrvāparayogasiddho bhavati/}}		
...
Both \SuComma{}{} and the excerpts from the \SS\ cited in the \emph{Jalpakalpataru} read \dev{ṛgvedādayastu vedāḥ}, ê
...
Thus, the decision to prioritize the \emph{Sāmaveda} as the prototype 
	...
	\dev{caturṇāṃ vedānāṃ madhye gānamādhuryeṇātiramaṇīyaḥ sāmavedo'hamasmi} 
...
Another early \SS\ manuscript from 1595 also keeps the same reading.\footnote{\MScite{MS Jodhpur RORI 20060} f.265r5.}
...
(1) The text suggests the etymology of the word \emph{veda} by mentioning two verb roots, namely \emph{vinda} and \emph{vida}. 
   ...
   forms ending in \emph{-a},\footnote{
 		 		E.g. as \root \emph{gam}, \root \emph{han}, \root \emph{vid}, and \root \emph{viś} are mentioned in \dev{vibhāṣā gamahanavidaviśām} (\volcite{}[7.2.68]{shar-2002}).}	 		 
 		 ending in \emph{-i},\footnote{ 
 		E.g. as \root \emph{mṛj} is mentioned in \dev{mṛjervibhāṣā} (\volcite{}[3.1.113]{shar-2002}).}	 		 
	  or with the ending \emph{-ti} in the present stem,\footnote{
	    ...
	    or sometimes with \se{anubandha}{indicatory sounds} as found in the \emph{Dhātupāṭha}\footnote{
   		E.g. as \root \emph{iṣ} is mentioned in \dev{iṣugamiyamāṃ chaḥ} (\volcite{6}[7.3.77]{shar-2002}). 
...
(2) The second issue pertains to the homonymy of \emph{vid} in Sanskrit \emph{Dhātupāṭha}s, 
	 		...
	 		\emph{\root vid} “to exist” to the fourth class (\emph{divādi} or the thematic \emph{ya}-suffix class).\footnote{
	 			Cf. \dev{sattāyāṃ vidyate jñāne vetti vinte vicāraṇe/ vindate vindati prāptau śyanlukśnamśeṣvidaṃ kramāt//} 
 			...
 			The form \emph{vinda} is, therefore, the present stem of the sixth-class verb \emph{vid}.\footnote{ 
 				...
 				\dev{anupasargāllimpavindadhāripārivedyudejicetisātisāhibhyaśca} (\volcite{}[3.1.138]{shar-2002}).}
...
\begin{enumerate}
	\item \dev{pūrvāparam upalakṣya vinda vida ityetayośca dhātvorekārthaḥ  | 
			paścāt padam bhavati āyurvedotpattimayaṃ vivakṣuriti} (Nepalese version)
	\item \dev{tatra pūrvāparayogamupalabhya viṃdatītyetayośca dhātvorekārthayoḥ 
		paścāt padaṃ bhavati āyurvedotpattimayaṃ vivakṣuriti} (\emph{Śuśrutapāṭhaśuddhi} \MScite{London BL IOLR 1842})
	\item \dev{tatra pūrvāparayogamupalabhya vid vicāraṇe vid vindatītyetayośca 
		dhātvoranekārthayoḥ prayogaḥ paścāt pratipattirbhavati āyurvedotpattimayaṃ vivakṣuriti} (\emph{Jalpakalpataru})
	\item \dev{vida vicāraṇe, vidḷ lābhe, ityetayośca dhātvoranekārthayoḥ prayogāt, 
		tatra pūrvāparayogamupalabhya pratipattirbhavati āyurvedotpattimayaṃ vivakṣuriti} \Su{}{}
\end{enumerate}
...
firstly, the contradictory readings of \dev{ekārthaḥ} or \dev{ekārthayoḥ} versus \dev{anekārthayoḥ}, 
and secondly, the syntactic structure of the sentence. 

(1) The Nepalese version and \MScite{MS  London BL IOLR 1842} uphold 
...
In essence, we are not able to grasp the \se{padārtha}{signification} of the word Veda 
by choosing one or the other meanings of the homonymous verb \emph{vid}. 
Be it \emph{Sāmaveda} or \emph{Āyurveda}, 
...
itself appearing after two sentences.\footnote{Cf. ‘\dev{āyurvedamicchāma ihopadiśyamānam}’ 
...
after the fact that the roots vind and vid have the same meaning, 
...
called \se{padārtha}{signification}. The meaning that is attached to 
one or more words is the \se{padārtha}{meaning of the words}. 
...
\item [11] The sense of the cause  (\emph{hetvartha})\sse{hetvartha}{sense 
of the cause} is a 
statement that is
...
\item [19] Ellipsis (\emph{vākyaśeṣa})\sse{vākyaśeṣa}{ellipsis} refers to an 
unstated word that 
...
\item [23] Invariable statement (\emph{ekānta})\sse{ekānta}{invariable 

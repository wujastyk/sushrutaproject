...
\item [39] A statement like “This and this…” is \se{vikalpa}{option}. For example, in the section on meat, the major ones are blackbuck, deer, partridge and francolin.

\item [38] A summarized statement is \se{samuccaya}{aggregation}. (?) For example, let there be rice with meat broth, rice with milk, or burley with ghee. 

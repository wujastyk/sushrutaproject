...
Each and every one of them\footnote{There is a question about what
    ...
    domain.\footnote{The Nepalese version had a quite different meaning
        ...
        ``\se{adhibhūta}{related to the physical}" in place of
        ``\se{vibhutva}{sovereignty}.''  This accords with texts like the
        \emph{Mahābhārata} 14.42.27–40 \pvolcite{18}[152--153]{sukt-1933} 
        and
        ...
        physical and divine levels. %(see Larson & Bhattācharya Sāṃkhya, p.
        % 315–326),
        }  There is their own \se{adhyātma}{personal aspect} and the
...
This whole group lacks consciousness.\footnote{I.e., the group of
    ...
    consciousness.  And that is united as \se{karaṇa}{instrument} and
    \se{kārya}{result}.\footnote{The vulgate text at this point has, ``is
        united by  \se{kāraṇa}{cause} and result,'' a quite different and
        easier reading.  In philosophical prose one would hesitate to
        interpret \se{karaṇa}{instrument} as \se{kāraṇa}{cause} As a dvandva, 
        \dev{karaṇakārya}  breaks Pāṇini 2.2.34 because \dev{karaṇa} has more
        vowels than \dev{kārya}. Reading the compound \dev{karaṇakārya} not 
        as

...
In medicine, however,\footnote{The word \dev{vaidika} here refers to 
medicine, not the Vedic tradition more widely.  Witness H and the vulgate read
the more common \dev{vaidyake}. 
...
\item[12]
\begin{quote}
One should describe the \sepl{bhūta}{element} that are born from that
specifically as having its qualities.\footnote{\dev{tato} “from that”
    refers to Prakṛti.} 
    From those, that have its \sepl{lakṣaṇa}{characteristic}, the entire  

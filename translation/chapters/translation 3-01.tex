...
Prakṛti.\footnote{\Dalhana{3.1.11}{341--342} discussed whether
    ...
    \emph{Śvetāśvataropaniṣad}, \emph{ibid}.}
    \end{quote}
...
senses.\footnote{Yuktidīpikā has a passage on this interpretation, that senses 
are from the bhūtas.}\q{fill out}
...
In the textbooks of Ayurveda, witnesses are not taught to be
omnipresent and [also] permanent. 

They bring forward reasons that elucidate the Person with
respect to the fact that witnesses are not omnipresent and [also] not
permanent. 

Because it is the established teaching of Ayurveda, witnesses are not
omnipresent but they are permanent.

They transmigrate into the wombs of animals, into humans and into gods.

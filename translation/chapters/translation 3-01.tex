...
In the Vedic tradition, however,\footnote{The word \dev{vaidika} here probably 
refers to the Vedic tradition, as it does generally in Sanskrit literature 
\citep[1022]{moni-sans}. Witness H and the vulgate read 
     \dev{vaidyake} “in the medical tradition.”  But the following statement
     listing different views about Prakṛti is not known elsewhere in medical 
     literature, but is very close to the \emph{Śvetāśvataropaniṣad}, 
...
\begin{quote}
    \sse{pṛthudarśin}{people with a wide perspective}People with a wide 
    perspective 
    consider
   \se{svabhāva}{essential being}, 
    ...
    separately. Cf.\ similar discussion in  \emph{Śvetāśvataropaniṣad} 1.1--2 
        \citep[414--415]{oliv-1998}.}\q{expand and note 
        Jejjaṭa's opinion.}
    \end{quote}
...
One should teach that  the \sepl{bhūta}{element} that are \diff{born from
    that} specifically as having its qualities.\footnote{\dev{tato} “from
    that” refers to Prakṛti. Note that this phrase differs from the
    vulgate text, but was known and accepted by Gayadāsa.} From those,
   the entire
    \sepl{bhūtagrāma}{family of living being} is generated,  having its 
...
Its application is always stated with regard to
medicine.\footnote{“Its” refers to the family of living beings.}
    Therefore in therapeutics, no consideration is given beyond the
    elements . %
    Because it has been stated “the elements etc.\ are a collection of
    substances that are its origin.”  \footnote{I.e., are a source
        of the “person” as the subject of medical science, are the

...
\begin{center}
    \DefTblrTemplate{firsthead,lasthead}{default}{}
\begin{longtblr}[
    headsep=0pt,
    presep=0pt]{
        colspec={XXX},
...
group.\footnote{I.e., the group of twenty-four
    ...
    and the \se{kārya}{result}.\footnote{The vulgate text at this point
        ...
        \dev{karaṇa} means \dev{kāraṇa} here, i.e., ``cause.'' The vulgate
        reading is the more prosaic.  If the compound \dev{karaṇakārya} is not
        ...
        of the Person's \se{kaivalya}{freedom}.\footnote{The
            ...
            one about milk, etc.\footnote{\Dalhana{3.1.8}{340}

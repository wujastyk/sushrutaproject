...
In medicine, however,\footnote{The word \dev{vaidika} here appears to
    refer to medical tradition, not the Vedic tradition more widely
    conceived. Witness H and the vulgate read the more common
    \dev{vaidyake}.} 
...
\begin{quote}
    People of broad vision consider Prakṛti to be
   Nature, 
    destiny,
    time, 
    \se{pariṇāma}{change},
    the Lord,
    or accident.\footnote{\Dalhana{3.1.11}{341--342} discussed
        whether these six entities were to be considered }
    \end{quote}
\item[12]
\begin{quote}
One should describe the \sepl{bhūta}{element} that are \diff{born from
    ...
    that have its \sepl{lakṣaṇa}{characteristic}, the entire
    \sepl{bhūtagrāma}{family of living being} is produced.

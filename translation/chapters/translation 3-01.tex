...
in the physical world (\emph{adhibhūta}), 
in the individual person (\emph{adhyātma}),
and in the divine realm (\emph{adhideva}).  While
...
literature, or anywhere.\footnote{These homologies in the \SS\ were
    noted by \citet[55]{comb-2011}. The adjacent
    topic of the three kinds of suffering was discussed
    by  \textcites{stei-2007}{vuka-2023}.
    For the Upaniṣads, one thinks of
...
critical apparatus for details.}  But they themself are the
\se{adhyātma}{personal aspect}.
The \se{adhideva}{divine aspect} is thus:
 Brahmā is of the \se{buddhi}{intellect}, 
Īśvara is of the \se{ahaṃkāra}{sense of the self}, 
the moon is of the mind, 
the directions is of the the ear, 
wind is of the the skin, 
the sun is of the the eyes, 
the waters is of the the tongue, 
the earth is of the the nose, 
fire is of the the voice, 
Indra is of the the hands, 
Viṣṇu is of the the feet, 
Mitra is of the the anus, 
and Prajāpati is of the the genitals.\footnote{Expressed as a table 
    in Table~\ref{adhideva}.} 
...
In the Vedic tradition, however,\footnote{The variant reading \dev{vaidika}, 
in witness N, probably 
would refer to the Vedic tradition, as it does generally in Sanskrit literature 
\citep[1022]{moni-sans}. Witness H and the vulgate read 
     \dev{vaidyake} “in the medical tradition.”  The following statement
     listing different views about Prakṛti is not known elsewhere in medical 
     literature, but is very close to the \emph{Śvetāśvataropaniṣad} and
     \emph{Gauḍapādakārikā} 1.8, 9 \citep[3--4, 62]{karm-1953}.} 
...
\begin{quote}
    ...
    people with a wide perspective 
    consider
   \se{svabhāva}{essential being}, 
    destiny,
    time, 
    \se{pariṇāma}{transformation},
    the Lord,
    and \se{yadṛcchā}{chance}
     to be Prakṛti.\footnote{\Dalhana{3.1.11}{341--342} 
    discussed whether these six entities were to be considered together or 
    separately. 
    Ḍalhaṇa seems to have accepted Jejjaṭa's view that these are multiple
    philosophical views, but that physicians consider the ultimate cause to be 
    Prakṛti.  He also recorded Gayadāsa's view that some thinkers believe that 
    these causes cumulatively constitute Prakṛti.
    Cf.\ similar discussion in  \emph{Śvetāśvataropaniṣad} 1.1--2 
        \citep[414--415]{oliv-1998}.}
    \end{quote}
...
\item[12]
\begin{quote}
One should teach that  the \sepl{bhūta}{element} that are \diff{born from
    her} as specifically having her qualities.\footnote{\dev{tato} “from
    her” refers to Prakṛti. Note that this phrase differs from the
    vulgate text, but was known and accepted by Gayadāsa.} From those,
   the entire
    \sepl{bhūtagrāma}{group of living being} is generated,  having their 
    \sepl{lakṣaṇa}{characteristic}.\footnote{\Dalhana{3.1.12}{341} took 
    “having 
        their characteristics” as referring to the characteristics of the \dev{bhūta} 
        “elements.”}
...
medicine.\footnote{\Dalhana{3.1.14}{341--342} explained that “its”
    ...
    (\dev{pañcamahābhūtārabdha}).} Therefore in therapeutics, no
    consideration is given beyond the elements. Because it is has been
    stated, 
    \begin{quote}[by saying `Puruṣa'] he has stated that it 
    originates from
    a collection of substances beginning with the
    \sepl{bhūta}{elements}.\footnote{I.e., the “person” is the physical
        subject of medical science, deriving fro the \sepl{bhūta}{element},
        etc.  The internal reference here is to \SS\ \Su{1.38}{9}.  In this
        passage, the \SS\ defined the \se{puruṣa}{human being} as a material
        creature made out of the five elements and the physical bodily parts
        and tissues.}
        \end{quote}
\end{translation}

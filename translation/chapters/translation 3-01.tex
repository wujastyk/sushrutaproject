...
Attributes that are \se{sāttvika}{pure} include: 
not being malicious,
enjoying sharing,
tolerance,
truthfulness,
...
Those that are \se{rājasa}{turbulent} include 
excessive suffering,
\se{apradāna}{being ungenerous},\footnote{The vulgate
    text prefers “excessive wandering about” here, as well as “having no 
    willpower.”}
bad behaviour,
...
pride,
\se{harṣa}{lust},
desire and aversion.\footnote{\dev{kāmakrodhaḥ} is a dvandva in the 
masculine.}

Those that are \se{tāmasa}{stultifying} include
depression,
...
Further, the qualities of space are
sound,
the sense organ for sound,
the aggregate of all spaces,
and 
the fact of being separated.

Those of are are touch, the sense organ for touch,
the aggregate of all gestures,
\ldots

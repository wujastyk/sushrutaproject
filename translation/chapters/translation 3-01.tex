...
Furthermore, the  \se{āntarīkṣa}{ethereal} attributes are sound, the
auditory faculty, the aggregate of all \se{chidra}{intervals} and 
separateness.\footnote{The term “ether,” translating
...
the aggregate of all \sepl{ceṣṭā}{gesture},
all \sepl{spanda}{spontaneous movement} of the body 
and lightness.\footnote{\Dalhana{3.1.19}{343} described “all gestures” as
    “bending and straightening, although others say all actions of body, voice 
    and mind” (\dev{namanonnamanādisarvakriyāsamūhaḥ, 
    kāyavāṅgmanaḥkriyāsamūha ityanye}).}
...
The earthy ones are smell, the olfactory organ, the aggregate of all
solid bodies,\sse{mūrti}{solid body} and heaviness.\footnote{There is
    a partial overlap of the elemental qualities listed in this section with those
    mentioned in some anonymous stanzas that appear in the 
    \emph{Yuktidīpikā} on
    \emph{Sāṅkhyakārikā} 28c \citep[225]{wezl-1998} and in 
    Vācaspatimiśra's \emph{Tattvavaiśāradī} on \PYS\ 3.44 
...
\begin{sloka}
 One should teach that all these pervade each other.
 
 It is accepted that the manifest character of all things exists in each of the 
 separate substances. 

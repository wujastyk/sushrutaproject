        ...
        reproduced in Figure~\ref{fig:biardeau1981-p27}.}
            ...
            \begin{figure}
                ...
                \begin{tikzpicture}[
                   ...
                   \node[right=2.5cm of avyakta] (purusa) {+ \; \textit{puruṣa}};
                   \node[left=3.9cm of avyakta] (kkk1) {}; %DW
                   ...
                   \node[below left=1cm and 1cm of ahamkara] (vaikarika) 
                   {vaikārika};
                   \node[below=1cm of ahamkara] (taijasa) {taijasa};
                   \node[below right=1cm and 1cm of ahamkara] (bhutadi) 
                   {bhūtādi};
                   ...
                   \node[below right=1.2cm and -.8cm of taijasa] 
                   (sabda){śabdatanmātra};
...
domain.\footnote{The Nepalese version had a quite different meaning
    ...
    \se{adhyātma}{personal aspect} and the \se{adhideva}{divine aspect}.
    Thus, \\
\begin{center}
\begin{tabular}{ll}
\toprule

...
[case, of phlegm].
    ...
    \begin{itemize}
        ...
        \item \se{gairika}{ochre}, \se{saindhava}{Sindh salt}, \se{kṛṣṇā}{long 
        pepper} 
        and the \se{maṣī}{black soot} from cow's teeth;\q{maṣī burned charcoal. Find 
            refs.}
        
        \item \se{gomāṃsa}{Cow's flesh}, \gls{marica}, 
        \gls{śirīṣa}
        ...
        \item
        or the the fruits of the \gls{svayaṃgupta}.
    \end{itemize}
...
\diff{\se{kupyaka}{metal}},\footnote{A metal other than gold or
 ...
 %   
    ...
    with \se{gairika}{ochre}, and the juice of \se{gośakṛt}{cow-dung} are a 
    \se{añjana}{collyrium}
    ...
    \se{rasāñjana}{Elixir-salve}, \se{kṣaudra}{honey}, ghee,
...
\se{gośakṛt}{juice of cow-dung} are for an eye afflicted with bile.
    ...
    a kind of \se{añjana}{collyrium}.  Cf.\ \cite[2.M13]{nadk-1954} and 
    \cite[197--198]{shar-1982}}
    and \se{saindhava}{Sindh salt} and long pepper and also 
    \se{hareṇu}{hareṇu}.  
...
%Caraka 2.734, AVS 1.128, NK #154} %
    ...
    For thirty days, this \se{añjana}{collyrium} is put in the mouth of a black 
    snake that is

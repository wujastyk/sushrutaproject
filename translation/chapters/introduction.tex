...
relationship of the work to the \CS\ and other works.  Former
arguments based on the priority of the \CS\ to the \SS\ can no
longer stand, since the Nepalese version does not include many of
the passages from the \CS\ on which these arguments rest.  A particularly striking 
example of this occurs in the \textit{Sūtrasthāna}.
...
professional physician. The title of the chapter is interesting: “how to start being a 
secular practitioner,” (\dev{विशिकानुप्रवेशनीयमध्यायम्}). The word I translate as 
“secular practitioner” is, etymologically, “without a top-knot,” i.e., a person who is 
...
religious functionary.\footnote{Some commentators interpreted the word 
\dev{विशिखा} to mean “path, road.” This sense is not known  outside the present 
passage. I would suggest it is an attempt to reverse engineer the chapter’s title to 
mean something like the Pali \emph{sotāpanna}.}
...
diagnostic procedure is found in the \emph{Carakasaṃhitā} (Ca.ci.25.22
). For that reason, this passage has been taken as evidence that the
authors of the Suśrutasaṃhitā knew the Caraka text and were responding
to it. This is one of the pieces of evidence that is used to argue
that the \emph{Suśrutasaṃhitā} is chronologically later than the
\emph{Carakasaṃhitā}. 
In the Nepalese version of the \emph{Suśrutasaṃhitā}, however, the
passage is much simpler and omits this second, distancing, voice:
...
\end{quote}
Tthe passage referring to the \emph{Carakasaṃhitā} is absent.
...
चक्रासंगतः}.}
Thus, we can 
say that it was added to the text of the \emph{Suśrutasaṃhitā} some time 
between the 
oldest Nepalese manuscript (878 \CE) and Cakrapāṇidatta’s time, i.e., the eleventh 
century.

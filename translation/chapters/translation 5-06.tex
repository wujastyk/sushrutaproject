...
\begin{translation}
    ...
    \item[1] Now I shall explain the \se{kalpa}{procedure} for
sounding the \se{dundubhi}{kettle drum}.\footnote{This title
    suggests that the chapter may once have begun with the words “the
    drums are to be sounded" (see P.) On the translation “kettle
    drum” see \cites[318]{hopk-1889}{ross-2014}.}\q{Find the rule}
    
    \item[3] One should take the ash of the following items, mix it
with cows' urine and an \se{kṣāra}{caustic} compound, take an
extract and cook it thoroughly: % deep  breath ...
...
\gls{pāṭalī}, \gls{pāribhadraka},\footnote{\label{drum-detox}The
    ...
    described in \SS\ \Su{5.3.9}{568}, p.\,\pageref{water-detox}
...
soot\sse{gṛhadhūma}{soot}, \gls{ananta}, soma,\q{Roots page
    ...
    \gls{elavāluka}, \gls{nāgadantī},\footnote{\Dalhana{5.6.3}{580}
        glossed \dev{nāgadantī} as a type of \dev{indravāruṇī}
        (\gls{indravāruṇī}), but he noted that Jejjaṭa had thought it was
        \dev{dantī} (\gls{dantī}).} \gls{ativiṣā}, \gls{bhadradāru},
        \gls{marica}, \gls{kuṣṭha}, and
        \gls{vacā}.\footnote{\Dalhana{5.6.3}{580} noted that Gayadāsa omitted
...
\glsplural{śvetā} and \gls{kākamācī} with cows' urine.  A ghee mixed with 

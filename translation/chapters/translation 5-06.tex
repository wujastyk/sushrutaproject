...
\se{śarkarā}{small urinary calculi}, \se{aśmarī}{urinary
    calculus},\footnote{\dev{aśmarī} and \dev{śarkarā} are described in
    ...
    be given for indigestion, \se{grahaṇīdoṣa}{humours of the
        ...
        summary by \tvolcite{2}[20--21, 96 \emph{et passim}]{rama-1985}.} 
        and
        severe \se{bhaktadveṣa}{aversion to food},\footnote{A sign of 
        impending death according to \SS\ \Su{1.32.4}{142}.} in swelling,
        \se{sarvasara}{mouth ulcer},\footnote{See \volcite{1}[888]{josi-maha} 
        and \SS\ \Su{2.16.65--66}{336} and \Su{4.23.3}{}.} and persistent 
        \se{śvāsa}{asthma}. %
        % give
        ...
        whose leader is Takṣaka.\footnote{\dev{takṣaka} is an ancient
            ...
            later works.}\textsuperscript{, }\footnote{There follow four
                ...
                \se{kalyāṇaka}{The Salutary}. This ghee recipe with the same name
                is also present in the \emph{Uttaratantra} at
                \Su{6.39.229--232}{689}, where it is a treatment for mostly
                similar ailments: chronic fever, asthma, cough, swelling, madness
                and a \se{gara}{toxic potion} (defined at

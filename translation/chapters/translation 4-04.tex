...
One should take 12 grams\footnote{The measure given is one
    \dev{akṣa}, which is approximately 12\,g (\citet[263]{wuja-2003}, based on 
    the fourteenth-century \emph{Śārṅgadharasaṃhitā}).} each
    of \se{kalka}{pastes} of 
    \gls{trivṛt}, 
    \gls{dantī}, 
    \gls{śaṅkhinī},
    \gls{suvarṇakṣīrī}, 
    \gls{triphalā}, and 
    \gls{viḍaṅga}, with 48
    grams\footnote{A \dev{bilva}, more commonly called a \dev{pala}, is
        approximately 48\,g  \citep[263]{wuja-2003}.} of \gls{tilvaka}-root
        and \gls{kampilya}, and six kilos\footnote{The measure given is two
            \dev{pātra}, which is a liquid measure of approximately 2 $\times$
            3\,kg \citep[263]{wuja-2003}.} of the juice of \gls{triphalā} and
            curds and three kilos of ghee.\footnote{\Dalhana{4.4.27}{422}
...
One should collect the wooden logs of the instruments that have been
used for a long time for extracting oil from sesame seeds. One should
then have them chopped into very tiny pieces and then pound those
pieces. Next, one should put them in a big vessel, submerge them in
water, and boil them. Then, one should collect the oil from the
surface of the water with either a cup or by hand. Thereafter, one should
properly cook wind-alleviating herbs with this oil that was
effectively cooked.  This is the \textit{aṇutaila}
    that is mentioned in wind disorders. It is called \se{aṇutaila}{fine oil}
    because it is produced from \se{aṇu}{tiny} oily objects.

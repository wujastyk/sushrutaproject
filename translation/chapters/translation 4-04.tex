...
\se{ṣaḍdharaṇa}{six-weight} \se{yoga}{formulation} together with
slightly warm water, for seven nights.\footnote{The vulgate has the reading
    \dev{chardayitvā} which means "after making [him] vomit". Thus,
...
\Dalhana{4.4.3}{420} noted that \dev{dharaṇa} here means a
particular weight. He also noted that \dev{sukhāmbu} (“pleasant

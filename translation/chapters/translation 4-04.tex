...
oil cooked with herbs like \gls{vidārigandhā}, and left in that
condition for one night.\footnote{\volcite{1B}[104,
    n.\,123]{meul-hist} noted that the \CS\ \Ca{6.26.23, 74}{598, 602}
    stated that the group starting with \gls{vidārigandhā}
    (\dev{vidārigandhā}) is the same as the \dev{hrasvapañcamūla} or
    the \dev{sthirādi} groups.} Next, one should put all the earth
    that is oily in water, and then pour it into a large caldron. %   
    %  \footnote{The reading in H,
    %            \dev{kaṭāhebhyaḥ siṃcet}, does not make sense here. Thus,
    % we have
    %            accepted the vulgate reading \dev{kaṭāhe 'bhyāsiṃcet} for
    % the
    %            translation.}
    The oil that rises up in that vessel should be taken out
    with both hands and stored well covered.  Next, one should
    thoroughly cook that oil a thousand times for as long as
    possible %            \footnote{The
    %                phrase "\dev{yāvatā kālena śaknuyāt paktum}" appears
    % as a part of
    %                a new sentence in H. But, we should take it to be a
    % part of the
    ...
    parts of each of the following---
                ...
                \textit{kāñjika}\footnote{Ḍalhaṇa
                    ...
                    Dictionary.}---and thus prepare the \se{sahasrapāka}{that

...
\gls{kākolī}, etc.\footnote{For grammatical accuracy, there needs
    ...
    lukewarm\footnote{\dev{sukhoṣṇam} may be an indeclinable. But, it
        could also be a grammatical inaccuracy where it should have a
    ...
    one thousand \textit{mātrās}. Enema (\dev{basti}) alone curtails the wind 
    that is situated throughout the whole body or in one part. This is just as the 
    wind [curtails] its force.\footnote{The last four words in H, \dev{tasya 
    vegam ivānilaḥ} do not make sense in the context.} 

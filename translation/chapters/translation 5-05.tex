...
\se{pracchita}{incised} with sharp ointment or \diff{with the remnants of
    ...
    great deal, \diff{is \se{śīrṇa}{putrid} is designated  
...
\gls{mañjiṣṭhā} group,\footnote{There is no \dev{mañjiṣṭhā} group. There is a
    plant \dev{vakra}, so a reading \dev{mañjiṣṭhavakre} “\gls{mañjiṣṭhā} and
    \gls{vakra},” instead of \dev{mañjiṣṭhavarge}, is conceivable.} and all 
    kinds of salt.\footnote{There is a
        \dev{lavaṇavarga} (\Su{1.46.313--321}{236--237}).} One may put this 
        in 
        a horn,
        together with honey.   This antidote destroys poison, being employed 
        together
        with drinks, \se{añjana}{collyrium}, \se{abhyañjana}{oil rubs}, errhines 
        and
        drugs.

With its relentless \se{vīrya}{potency} and as a destroyer of the
\se{vega}{toxic reaction} to poison, it is called “The Great Antidote” and has
great power.
\end{sloka} 
...
\gls{padmaka}, 
\gls{punnāga},
\gls{tālīsa}, %?  % got to here 
\gls{suvarcikā},
\gls{kuṭannaṭa}, %? %śyonāka
\gls{elā},
\gls{asitasinduvāra}, %? %śvetanirguṇḍī
\gls{śaileyaka}, %?
\gls{kuṣṭha},
\gls{tagara},
\gls{priyaṅgu},

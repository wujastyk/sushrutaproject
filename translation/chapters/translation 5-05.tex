...
After \se{incising}{pracchāna} the area around the bite, one should smear
...
poison.\footnote{Strictly, \dev{viśanāśanam} “that destroy poison” does
    ...
    agreeing with the dual compound.  The rare word \dev{nastaḥ} “from or
...
At the fifth and sixth \se{toxic reactions}{vega} one should make the
person drink something that aids cooling, that is cleansing
and sharp, and a well-regarded gruel too.
    
\item [23]

\diff{But at the seventh, one should clean out\q{purge?} his head with a sharp
...
\item [24] Regarding Maṇḍalins,\footnote{Genitive absolute.} at the
    earliest \se{toxic reaction}{vega} one should proceed in the same way as
    with Darvīkaras.\q{pūrvā? vegā?}\footnote{The vulgate again adds a
        half-verse here, recommending the “crow's foot” incision on the patient's
        head. On this procedure, see \cite[145]{wuja-2003}. This text is not

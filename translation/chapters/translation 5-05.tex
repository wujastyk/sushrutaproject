...
\gls{haridrā}, the \gls{mañjiṣṭhā} group,\footnote{There is no
    \dev{mañjiṣṭhā} group. There is a plant \dev{vakra}, so a reading
    \dev{mañjiṣṭhavakre} “\gls{mañjiṣṭhā} and \gls{vakra},” instead of
    \dev{mañjiṣṭhavarge}, is conceivable.} and all kinds of
    salt.\footnote{There is a \dev{lavaṇavarga}
...
\item [73ab--75ab] One should make powder of the following items and
place it in a cow's horn, covered as before:\footnote{“Cover”
    translates the unusual lexeme \dev{āpidhāna} (for \dev{apidhāna}); the
    term is known very rarely from early Vedic literature.} \gls{lākṣā},
    the two \glspl{hareṇu}, \gls{nalada}, \gls{priyaṅgu}, \gls{mañjiṣṭhā},
    \gls{yaṣṭī} and \gls{pṛthvīkā}.  This group that has been described is
    mixed with \gls{rajanī}, honey and ghee.  \diff{It should then be used
        with \se{añjana}{collyrium}, drinks and errhines.}  This antidote is
    called “\se{sañjīvana}{Reviver}” because it causes those who are dead in
    this world, whose breath seems to be gone, to live.

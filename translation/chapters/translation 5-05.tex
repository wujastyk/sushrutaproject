...
as well as \se{bali}{sacrificial offerings}, and with \se{japa}{mantra
    ...
    with an animal (\dev{sapaśunaivedya}).}\q{German philologists, see here.}
...
smear it with \se{agada}{antidotes} and sprinkle it with water infused with 
\gls{candana} and 
\gls{uśīra}.\footnote{\dev{pracchāna} is the second method of 
blood letting  described in \Su{1.14.25}{64} (this verse does not appear in the 

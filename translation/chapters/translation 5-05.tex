...
One can conquer phlegm with the group that comes after \gls{āragvadha},
...
\se{pracchita}{incised} with sharp ointment or \diff{with the remnants of
    the poison}, then when the limb swells up, the the flesh that becomes
moist, smells a great deal, \diff{is \se{śīrṇa}{putrid} is named  
“\se{viṣapūti}{poison-stink}.”}

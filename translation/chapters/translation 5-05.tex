...
extremely hard to overcome. If even a small amount is left over,\q{check
    MSS on emendation to avaśiṣṭa from avatiṣṭha} it can strongly bring about
a toxic reaction, 

\item[48cd--49] Or may lead to dejection, pallor, fever, cough and headaches,
dessication, swelling, catarrh, poor vision, \se{aruci}{disinterest in
    food} or \se{jāḍyatā}{rigidity}.\footnote{\Dalhana{5.5.49ab}{577} reported 
    a reading from Jejjaṭa of \dev{staimitya} “immobility” instead of 
    \dev{pratiśyāya} 
    “catarrh.”}
    And in such cases one should apply the cure as appropriate.   

\item[50--51ab]

One should also treat the \se{upadrava}{secondary
    ailments} of a poisoned patient each in its own way.

To the extent that, after the the \se{ariṣṭā}{bandage} has been removed and 
after the marked place has been quickly \se{pracchāna}{incised} with 
that,\q{?} one can see poison that has leaked out there, a toxic reaction may 
strongly be brought about. 

\item[52.1]



Once the poison has disappeared   

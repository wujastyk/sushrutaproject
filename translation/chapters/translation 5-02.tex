...
as the desire to urinate.\footnote{\Cs{1.7}{49--55}, discussed and
    translated by \citet[ch.\,1]{wuja-2003}.}\q{check page nos.}
...
snake-bite.\footnote{\AS\ \As{6.40.35}{844}: \dev{sapteti vegā
    ...
    experienced specifically by a person bitten by a snake (\dev{vēgān 
    dhanvantaristadvatsarpadaṣṭasya manyate/} 36ab).  The
...
about stationary poisons.\footnote{No reference is made to
    ...
    6]{NK}.  The dose can be quite small.}
        ...
        \item \diff{\gls{subhaṅgurā}},\footnote{The plant is usually
    called just \emph{bhaṅgurā} without the prefix \emph{su-}
    “good.”  However, there is no reported toxicity associated
    with \emph{E. prostrata}.  The vulgate reads \dev{sugandhā}
    (\gls{sugandhā}).}
        
       \item \diff{\gls{karaṭā}},\footnote{This poisonous root cannot
...
With \gls{pālaka},
% $\rightarrow$  citraka}{Plumbago zeylanica
...
\item[15b] With \gls{mahāviṣa},
    ...
    the belly.\footnote{The poisonous root \egls{mahāviṣa} is not clearly 

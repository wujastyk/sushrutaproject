...
%    them, \egls{viṣāṇī} (also \egls{meṣaśṛṅgī}), is sometimes equated with
...
\diff{\gls{reṇu}},\footnote{\dev{reṇu} and \dev{reṇuka/kā} are
    different plants. \MS{Kathmandu KL 699} reads the first; the scribe

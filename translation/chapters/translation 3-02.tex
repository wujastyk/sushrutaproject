...
chief element, then the fetus is fair.\footnote{The food of the
    ...
    \dev{śyāma}
        ...
        snakes, scorpions and \se{galagoḍikā}{snakes} that inhabit black,
        yellow or white land are black, yellow or white.\footnote{The 
        \dev{galagoḍikā} is a poisonous insect described in \SS\ 
        \Su{5.8.29}{588} 
        as a biting insect that may be white, black, with red stripes or rings or 
        spotted.  It is described just before centipedes.  The name is unstable, 
        e.g., \dev{galagolikā, galadoḍī, galagolī}.}

...
“Āsekya”.\footnote{Etymologically, “to be poured into."}\q{Think about 
this.}  Without doubt, after eating something 
\se{śukla}{white}, his flag is raised.\footnote{\Dalhana{3.2.38}{348} made 
it clear that this is a metaphor for having a penile erection.
...
Kumbhīka.\footnote{The vulgate adds an avagraha before
...
is termed an Īrṣyaka.\footnote{Etymologically “an envier."  
    
    Here again, \Dalhana{3.2.40--41}{349} cited the opinion of “another 
    book” and cited a passage from the \CS\ (\Cs{4.2.20}{303}).} 

\item [41d--42]

Hear about the fifth, the (\emph{Ṣaṇdhaka}).  A man who erroneously has 
sexual activity with a \se{kaumārī}{young girl} during her season as if he 
were a woman.  In such a case, a male is born who looks and behaves like a 
woman.  He is termed a \emph{Ṣaṇḍha}.\footnote{The vulgate's 
\dev{bhāryā} “woman, wife” for \dev{kaumārī} “girl” is probably 
bowdlerization.}
    
\item[43]
    
If a woman, during her season, has sexual activity like a man, then if a girl is 
born she will have the behaviours of a man.

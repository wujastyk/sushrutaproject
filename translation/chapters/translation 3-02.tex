...
In that context, the element of \se{tejas}{heat}
is the most important  factor where \se{varṇa}{complexion} is concerned.  
That being granted, at the moment the fetus is formed, when 
the food has water as its chief element, then the fetus is fair.  When earth is 
the predominant element, it is dark. When earth and ether are the chief 
elements, it is \se{śyāma}{dark}.

...
\subsection{JG translation}             
 ...
 \item[4]
  ...
  \saneng{śonita}{bleeding} there will be a discoloration due to blood and a 
  sensation similar to 
  that when there is a bile affliction. Moreover when caused by 
  \saneng{rakta}{blood} there is the smell of
  decomposition.  Phlegm with wind causes the appearance of lumps,
  bile with \saneng{śonita}{bleeding}  causes the appearance of 

...
its chief element, then the fetus is fair.\footnote{The food of the
    ...
    \dev{śyāma}
        ...
        white.\footnote{\label{galagodika}Cf.\ also n.\,\ref{godheraka},
            ...
            In that context, \se{jātyandha}{congenital blindness} is caused by the
            element of \se{tejas}{brilliance} not reaching the location of
            \se{dṛṣṭi}{eye}.  Similarly, red eyes are a consequence of blood,
            white eyes are a consequence of phlegm, yellow eyes are a 
            consequence of bile, and \se{vikṛtākṣa}{strabismus} are a 
            consequence of wind.
  
% got to here 2024-06-14 

%Thus the Tejas-principle makes a newborn irreversibly blind from 

...
For three days, the husband should \se{\root rakṣ}{spare} the woman
...
from the palm of her hand, from a plate or from a leaf.\footnote{This
    sentence is hard to construe because \dev{haviṣyaṃ} “ritual food”
    should not be the object of \dev{-bhojinīṃ}.}
...
\newpage
  \begin{tt}
     \bigskip
     \raggedright
% 25 Why should her partner arrive 
% late during the day? It is claimed that if she puts a collyrium, a child will be 
% born 
% blind, if she is weeping, he will have abnormal vision, by bathing and 
%anointing 
...
% continuously busy he will become a restless and troubled character. When 
%she 
% behaves accordingly, she well be the best of future mothers. She should 
%take 
% rest on a layer of Kuśa  grass,  take Haviśya-food so pure that it is fit for a 
% sacrifice**, eat varied food from the palm of her hand or from a plate made 
%of 
% leaves and she should keep herself then from her husband from the third 
%day 

...
And on this, there are the following:

\begin{sloka}
    %1
If a pure wind affects someone's eyes, those eyes will
consequently become sunken, dark and white.\footnote{The grammar
    of this sentence is imperfect.}
...
someone's eyes, their eyes are termed “yellowish-red.”
    ...
    %3
When phlegm that is free of any impurity moves to the eyes, their eyes shine 
with a white circle within a circle. 
    
    %4
    When blood mixed with phlegm moves into the eyes, their eyes become 
    pigeon-blue, or else red.
  
    \end{sloka}

\item [3.2.36]

Just as the ghee in a pot placed on a fire liquefies, so the
menstrual blood of a woman may flow out after sex with a man.

\item [3.2.37]

But when the wind splits the \se{bīja}{seed}, two lives 
(\emph{jīva})\sse{jīva}{life} come into the \se{kukṣi}{belly}.
They are called “a \se{yama}{pair},” being created from preceding

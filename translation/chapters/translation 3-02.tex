...
The term for men and women who have diminished seed is “\se{āsekya}{to 
be poured into}.”\q{Think about this.}  Without doubt, after eating something 
\se{śukla}{white}, his 
flag is raised.\footnote{\Dalhana{3.2.38}{348} made it clear that this is a 
metaphor for having a penile erection.

“Eating something white” probably refers to \dev{śukra} “sperm,” the 
...
referent of the term, not its meaning.

Some of the features referred to by the term \dev{ṣaṇḍa/ṣaṇḍha} may
include conditions such as Mayer-Rokitansky-Küster-Hauser syndrome
and Morris syndrome.  The central idea in the Sanskrit usages is that
such a person cannot produce children.}

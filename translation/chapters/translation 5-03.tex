...
\noindent
{\centering\small \begin{longtable}{ 
>{\raggedright\arraybackslash}p{.61\textwidth} 
>{\raggedright\arraybackslash}p{.33\textwidth}} 
\toprule 
\emph{creatures} & \emph{location of the poison}\footnotemark\\ 
\midrule 
\endfirsthead  
\toprule  
...
cats, dogs, monkeys, \se{nara}{men},\footnote{Perhaps dittography from
    ...
    crocodiles, frogs, \gls{pākamatsya},\footnote{The scribe of
        ...
        \dev{matsya}
        with a daṇḍa, indicating that they were separate
        terms (see \pageref{pakamatsya}).} monitor lizards, \glspl{śambūka},
        \se{pracalāka}{`poisonous snakes'},\footnote{\emph{Arthaśāstra}
            14.1.14, 23 \citep[448]{oliv-2013}, where it might also be a 
            chameleon; but the latter are not venomous.}
            \glspl{gṛhagoḍikā},\footnote{\label{grhagodika}The  scribe of
                ...
                the \CS\ and elsewhere in literature (cf.\ note \ref{galagodika},
                p.\,\pageref{galadodika}).} four-footed insects and
                others &  in their nails, mouths and fangs\\[2ex] 

% 4
 \se{kiṭipa}{lice}, \se{picciṭā}{`flat insects'}, 
...
% 8
flies, \se{kaṇabha}{wasps} and leeches 
...
the bone of one killed by poison, 
    \gls{sarpakaṇṭaka},
    \gls{varaki},
    & poisons in their bones\\[2ex]

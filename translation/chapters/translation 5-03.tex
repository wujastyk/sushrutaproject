...
And now we shall explain the \se{kalpa}{rule} that is the required
...
\item
 \se{avaśardhita}{fart},\footnote{This interpretation  comes from Ḍalhaṇa on 
 \Su{5.3.4}{567}, but he reads \dev{viśardhita}.}
...
fangs 							& 
spiders \\[2ex] 
  in the bites of their mouths  & flies,  
\se{kaṇabha}{wasps} 
and leeches \\[2ex] 
...
\item
 [8]  Men, horses and elephants who swim in it  experience vomiting, delusion, 
 fever, swelling and sharp pains.\footnote{On  the polysemy of 
 \se{nāga}{elephant\slash  snake}, see \cite{seme-1979}.}  He should try to 
 purify that polluted water,  after curing their ailments.  
...
%Erythrina suberosa,  GVDB 245 with \gls{pāṭalā} 
...
and  \gls{sidhraka} 
 ...
 % āragvadha, GVDB 37  Cassia fistula 
 %%%%%%%%%%%%%Linn 
 and  
 \gls{somavalka}. Then he should sprinkle that ash, 
 cold, on  the waters.  

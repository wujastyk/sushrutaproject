...
shaking of the limbs and fatigue.\footnote{The next vulgate verse is
    ...
    contaminated vyāna mixed with cough and phlegm. \cite[264]{vulgate}.
    ...
    \se{uddaṇḍaka}{stiffening}, and swelling with pain.\footnote{The word
        ...
        medical term. Some of these symptoms are in common with Stiff Person
        Syndrome.}
...
% got to here
In general, wind-blood causes irritation of those who are delicate and have 
inappropriate food and leisure, 
and because of the torment of the humours, roads, drunkenness from wine, 
and exercise

afflicted by humours, \se{adhva}{path}?, intoxicating drinks, enjoyment, and 
exercise, from the reversal of seasons and regions, and from the consumption of 
unwholesome foods, grossly exercise aggravates \se{vātarakta}{gout}.
	
	\footnote{\Dalhana{2.1.40--41}{263} commented that some scholars do not 
	read these two verses here because these will be read in the Cikitsāsthāna 
	(\Su{4.5.5}{424}).  In fa.ct, at that location, only 2.1.40ab and 2.1.41cd are 
	read.}

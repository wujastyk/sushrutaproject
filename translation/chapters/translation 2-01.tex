...
convulsions again and again and because of frequent convulsions \dev{आक्षेप} it is 
called \dev{आक्षेपक}.

%types of \dev{अपतानक} are being described.
\item[52--56] Because in this situation a person often sees darkness and
fall, it calls \se{अपतानक}{spasmodic contraction} \footnote{Gayadāsa
    ...
    situation is known as \se{अन्तरायाम}{emprosthotonos}. When vitiated wind
...
incurable \footnote{According to Ḍalhaṇa \se{आक्षेपक}{convulsion} is also known as 
...
\item[85] Vitiated wind penetrating into the cheekbones, temporal bones, head and neck causes piercing pain in the ears. It is called \se{कर्णशूल}{ear-ache}.\footnote{In the medical terms, this disease is known as Otitis.}
...
\item[88--89] Retention of vitiated wind inside abdomen causes distension of the stomach and flatulence and intense pain and rumbling inside, is called \se{आध्मान}{tympanites}. Vitiated wind mixed with phlegm causes \dev{प्रत्याध्मान}. It rises in the stomach and causes pain in the heart and sides. \footnote{There’s an addition in ms N. \dev{नाभेरधस्तात् संजातः संचारी यदि वाऽचलः}}

...
the torment of the \diff{humours},\footnote{“Wind-blood” is described in the
    ...
    exercise,\footnote{Probably, the “torment of the roads” refers
        ...
        sexual intercourse,” which makes little sense.
             ...
             \Dalhana{2.1.40--41}{263} commented that some
            scholars did not read these two verses here because these are read
            later, in the Cikitsāsthāna (\Su{4.5.5}{424}).  In fact, at that
            location, only 2.1.40ab and 2.1.41cd are read.  
...
\item[42--44]
	...
	The wind becomes aggraveted by riding elephant, horse, camel and other causes.
	\footnote{Ḍalhaṇa explained the words \dev{anyaiḥ kāraṇaiḥ} as to carry loads also be the cause 	of aggravation of the wind.} 

	And consuming vegetables which are pungent, hot, sour, alkali and frequent affliction 	quickly 	agitates the blood. And that swift one obstructs the path of the wind which moves fast.

	Having quickly moved, enraged by the obstruction of the passage, it extremely distressed.

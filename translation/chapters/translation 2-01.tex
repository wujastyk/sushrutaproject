...
\item[50--51]
	...
	When agravated wind enters in all the arteries, the quickly moves wind repeatedly
	convulse the body again and again. Because of frequent
...
\item[52--56]
	...
	calls \se{apatānaka}{spasmodic contraction} \footnote{Gayadāsa read 
	\dev{ताम्यते} which vulgate does not read.  He gave definition of \dev{अपतानक} as 	\dev{येनापताम्यते} means a situation in that a person sees the dark.} . 

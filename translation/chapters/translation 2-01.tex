...
and it brings about  \se{ardita}{paralysis}.\footnote{This condition
    ...
    simpler than the vulgate.  The latter includes a list of specific
    facial locations locations that wind may afflict, and a list of
    vulnerable types such as women who have recently delivered, children,
    old people, etc.}
...
copied this sentence.} And there is pain in the neck, chin and teeth on that side.

...
\item[52--56]
	...
	Since a person blacks out (\emph{apatāmyate}) completely, it is known
as a \se{apatānaka}{seizure}.\label{apatānaka}\footnote{Explaining
    \dev{apatānaka} by reference to \dev{apatāmyate} is a folk etymology,
    since the words have different etymological roots.

...
stiffening and \se{uddaṇḍaka}{being like a vertical stick} swelling with pain.

	\footnote{Nepalese version omits next verse which describes diseases that cause by contaminated vyāna mix with cough and phlegm. \cite[264]{vulgate}.} Instead of this verse, Nepalese version has a different hemistich here which is \dev{stambhanoddaṇḍakaś cāpi śothaśūlaṃ kaphāvṛte ||}.  


	% Symptoms of vātarakta that arises when wind mixes with blood.
\item[40--41]

	Mostly, in delicate people, those who follow faulty diet and lifestyle, afflicted by humours, \se{adhva}{path}?, intoxicating drinks, enjoyment, and exercise, from the reversal of seasons and regions, and from the consumption of unwholesome foods, grossly excercise aggravates \se{vātarakta}{gout}.
	
	\footnote{\Dalhana{2.1.40--41}{263} commented that some scholars do not read these two verses in vātavyādhinidāna because these should be read in vātavyādhicikitsā.}

\item[42]

	Riding elephant, horse, camel and others, consuming
	vegetables which are pungent, hot, sour, alkali and being frequently
	distressed situation the wind may become aggravated.

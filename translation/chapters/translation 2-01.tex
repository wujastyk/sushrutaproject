...
\se{gṛdhrasī}{sciatica}.\footnote{On ``\se{gṛdhrasī}{sciatica}" see
    ...
    etiology of the term is obviously not to be assumed.  The term is
    sometimes interpreted as ``lumbago'' or ``rheumatism,'' although the
    condition described here specifically affects the feet and thighs and
    might have included symptoms of gout. The term is unknown outside

...
Wind connects the senses and the sense 
objects; unvitiated, it maintains a state of equality between the
\se{doṣa}{humours}, the \se{dhātu}{bodily tissues} and \se{agni}{heat}
and the \se{ānulomya}{rightness} of actions.\footnote{ According to 
Ḍalhaṇa, \dev{sampattiḥ=sampannatā} at
    1.6.3 (Su1938:23). According to Ḍalhaṇa, Gayadāsa read
    \dev{indriyārthopasaṃprāptiṃ} but Ḍalhaṇa did not accept this 
    on the grounds that it was too verbose: \dev{gayadāsācāryastu imaṃ 
    ślokaṃ `indriyārthopasaṃprāpti'
    ityādi kṛtvā paṭhati, sa ca vistarabhayānna likhitaḥ /} But H and N MSS
    suggest `\dev{indriyārthopasampattiḥ}'}

\item[11] 

Just as the five types of fire have been described based on their

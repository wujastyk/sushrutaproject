...
fall down, it calls \dev{अपतानक} \footnote{In the medical term
    \dev{अपतानक} is known as epilepsy without convulsions. Gayadāsa described
    the Nepalese reading \dev{ताम्यते} which vulgate doesn’t read. Gayadāsa
    gives definition of \dev{अपतानक} as \dev{येनापताम्यते} means a situation
    ...
    \dev{दण्डापतानकः} epilepsy with convulsions. Vitiated wind entered in the
    arteries and bends the body like a bow, it is called \dev{धनुःस्तम्भ}

...
\subsection{Symptoms of diseases that arise because of a combination of five-winds with other humours.}

\item[31cd--32ab]

	The wind that is mixed with others produces mixed types of diseases in the places mentioned 	above and located in the limb, causes many diseases. 

	\footnote{Nepalese version omits next two verses
	\dev{dāhasaṃtāpamūrcchāḥ syurvāyau pittasamanvite || śaityaśophagurutvāni tasminneva kaphāvṛte | 	sūcībhiriva nistodaḥ sparśadveṣaḥ prasuptatā ||} These are about the diseases that arise when 	contaminated wind mixes with cough, phlegm and blood. \cite[263]{vulgate}.}

	% Symptoms of diseases that arises when prāṇa mixes with other humours (bile etc.)

\item[34cd--35ab]

	Prāṇa surrounded by bile causes vomiting and burning sensation and surrounded by
...
\item[35cd--36ab]
	...
	Udāna surrounded by bile causes disorientation, stupor,
	dizziness and exhaustion and surronded by phlegm it causes absence of perspiration, erection?
	slow digestion, coldness.

	% Symptoms of diseases that arises when samāna mixes with other humours (bile etc.)

\item[36cd--37ab]

	Samāna wind surrounded by bile causes perspiration, a burning sensation,
	heat and stupor and association with phlegm it causes erection in urine,
	feces and limbs.  
...
\item[37cd--38ab]
	...
	voiding of blood with urine and with phlegm it causes a feeling of
...
\item[38cd--39ab]
	...
	limbs and fatigue and surrounded by phlegm it causes stiffening limbs, uddaṇḍaka? and
	pain in the swelling.

	\footnote{Nepalese version omits next verse which is
	\dev{gurūṇi sarvagātrāṇi stambhanaṃ cāsthiparvaṇām | liṅgaṃ kaphāvṛte vyāne 	ceṣṭāstambhastathaiva ca ||} The verse describes other diseases that cause by contaminated vyāna 	mix with cough and phlegm. \cite[264]{vulgate}.} Instead of this verse, Nepalese version has a 	different hemistich here which is \dev{stambhanoddaṇḍakaś cāpi śothaśūlaṃ kaphāvṛte ||}.  

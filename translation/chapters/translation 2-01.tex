...
It is wind mixed up with phlegm. \footnote{Witness N includes}\q{complete} 

\item[90]
%[If it starts from below the navel and moves ]

A long, dense knot like a stone that protrudes upwards is known as
...
pathways.\footnote{\Dalhana{2.1.90}{270} discussed the identity of the
    ...
    kind of long, round stone known in north India, and others who 
    thought it was a long, round, iron vessel used by leather workers.
    
    Ḍalhaṇa glossed \dev{bahirmārgāvarodhinīm} “blocking the external
pathways” as “wind, feces and urine.”
    
    Finally, Ḍalhaṇa also noted that “some sources have the phrase 
    \dev{nābheradhastātsaṃjātaṃ calaṃ vā yadi vā'calam} `something 
    produced below the navel, either moving or still.'\,”  And in fact, 
    witness N has this half-śloka between 2.1.89 and 2.1.90.}

%He describes Vātāṣṭhīlā with the words "like an aṣṭhīlā," etc. Some say, "An 
%aṣṭhīlā is a specific type of long, round stone in the northern region 
%(uttarāpatha)." Others say, "It is a long, round iron anvil of a leatherworker." 
%Ghanaḥ means dense, with compact parts. Āyataḥ means long. Bahirmārgāṇi 
%refers to the external passages for flatus (vāta), feces (viṭ), and urine (mūtra). 
%Others read here, ‘Arisen below the navel, either mobile or immobile.’
%
%He describes Pratyaṣṭhīlā with the words "this very," etc., meaning this very 
%aṣṭhīlā. The difference between aṣṭhīlā and pratyaṣṭhīlā is that the latter 
%arises 
%obliquely. After this, some read [the section on] ūrustambha (stiffness of the 
%thigh), but this is incorrect because it is discussed later in the section on 
%treatment (cikitsā) and is not accepted by the commentators (nibandhakāra). 
%(Verses 90-91)
...
%	\se{gadgad}{stammers}.\footnote{Nepalese Manuscripts read 
%\dev{मिर्म्मिर}

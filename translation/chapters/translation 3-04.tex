...
\subsubsection{Against sleeping in the daytime}
...
\se{grīṣma}{summer}.\footnote{On the shifting terminology of seasons
    ...
    \se{kṣatakṣīṇa}{with a chest injury},\footnote{The condition is the
        subject of \CS\ \Ca{6.11}{478--482}.}\q{more on this; from
            over-exertion} people who have drunk alcohol,\footnote{The vulgate
            reads “who are always drunk.”} women, and those who are exhausted 
            by
            the action of travelling in a vehicle or on foot, those who have not
            eaten, and those with reduced fat, wind, phlegm and
            chyle.\footnote{The list of vulnerable types, “children, the elderly,
                \ldots” is a standard formula that appears in several other locations
                in the \SS.} %
                For those who are awake at night, you see, one may sleep during the
                day for half the time he was awake.

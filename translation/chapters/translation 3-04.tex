...
divides up the \se{koṣṭha}{abdominal cavity}.
 ...
 There is a verse on this:
 \begin{sloka}     
      The impurity located at the \se{uṇḍuka}{lower intestine} is divided by
the \se{kalā}{membrane} called \se{maladharā}{impurity-support}.
It is attached all around the liver and the
\se{koṣṭha}{abdominal cavity} as well as the
...
The term \dev{uṇḍuka}, “lower intestine, rectum or anal canal,” is of uncertain
...
as the location of the stomach, digestive fire, digested food,
urine, blood, heart, rectum and lung (\dev{pupphusa}); see
\volcite{1}[241]{josi-maha} for further citations.

See the diagram of the peritoneum in \cite[fig.\,3]{isaz-2018}.}
\end{sloka}
...
semen is discharged from it.\footnote{The vulgate text has an additional verse 
at this point.}.

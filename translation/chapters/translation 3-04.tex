...
of \sepl{tvac}{skin} and \sepl{kalā}{integument} that form early
in the fetus's life.\footnote{On the system of the \dev{kalā} see
    ...
    system of dermal and interstitial \sepl{kalā}{integument} was not
...
reconstructions at \volcite{2}[plate LXXI]{mukh-1913}.  }
 ...
 You see, the seven \sepl{kalā}{integument} also arise,  which are the 
...
the \sepl{kalā}{integument} parts are 
...
\end{sloka}
 ...
 From it arise 
 ever new \sepl{pratāna}{ramification} of the 
 flesh, 
 \sepl{sirā}{duct}, \sepl{snāyu}{ligament}, \sepl{dhamanī}{pipe},
 and  \sepl{srotas}{tube}.\footnote{On these different conduits, see 
 \cite[404--406]{wuja-2022}.}
...
As lotuses in a pond grow in all directions in the soil  having a place in mud(dy) 
water, so too  the veins (spread) through/in the flesh.

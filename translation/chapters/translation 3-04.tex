...
And there is a verse on this.
\begin{sloka}    
What is considered the highest \se{prasāda}{nutriment} of blood and
phlegm is cooked by bile, and the wind too follows
that.\footnote{The \dev{prasāda} “nutriment” is one of the two
    components of humoral substances (or sometimes of the
    \sepl{dhatu}{body tissue}), the other being the \dev{mala}
    “impurity."  See \volcites{1}[536]{josi-maha}{}[563 et
    passim]{das-2003}. Note that blood is here treated as a humoral
    entity (cf.\ \SS\ \Su{1.1.24(2)}{6}). Ḍalhaṇa reported that the
    commentator Gayadāsa added the phrase “[being cooked] within the
    heart."}
\end{sloka}
...
and bladder. In that context, the child, being stirred and heated
like gold develops a tongue by which he can sense tastes.\footnote{The
    grammatically unusual term \dev{dhāmyamāna} “heating” is common in
    alchemical literature; see \cite[passim]{hell-2009}.

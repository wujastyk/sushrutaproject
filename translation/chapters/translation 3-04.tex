...
the \se{kalā}{membrane} parts are 
hidden by \sepl{snāyu}{sinew} and 
covered by \se{jarāyu}{amnion}
and also 
surrounded by \se{śleṣman}{mucus}.
\end{sloka}
...
all others, fat is said to occur together with blood.\footnote{The
    vulgate text adds half a verse here introducing \emph{vasā} as a type
    of fat that is specifically present in “pure flesh.”  It seems that
    the Nepalese version does not use the term \se{vasā}{fat} at this point.
    \Dalhana{3.4.13}{356} called \emph{vasā} a \se{upadhātu}{subsidiary
...
supports    the four kinds  of food that have descended from the
stomach into the \se{pakvāśaya}{colon}. Being located in the colon, it
divides up the \se{koṣṭha}{abdominal cavity}.
 ...
 There is a verse on this:
 \begin{sloka}     
 The \se{kalā}{membrane} that carries the impurities separates the
 impurity located in the \se{uṇḍuka}{rectum}. It is attached all around the liver 
 and the \se{koṣṭha}{abdominal cavity} as well as the 
 intestines.\footnote{\Dalhana{3.4.17}{356} discussed this passage in detail, 
 citing Gayadāsa, Vṛddhavāgbhaṭa and Caraka.  Each of these authorities had 
 different interpretations of the passage.
 
The term \dev{uṇḍuka}, “rectum” or “anal canal,” is of uncertain
interpretation. Ḍalhaṇa said that the ordinary-language term for
\dev{uṇḍuka} was \dev{poṭṭalakā};  see further references in
\volcite{1}[109]{josi-maha}.

 The \dev{koṣṭha} “body cavity,” is described at \Su{4.2.12--13}{409}
as the the location of the stomach, digestive fire, digested food,
urine, blood, heart, rectum and lung (\dev{pupphusa}); see
\volcite{1}[241]{josi-maha} for further citations.}
\end{sloka}
...
\se{\root pac}{cooks} the fourfold items known as “eaten, drunk, chewed and
licked".\footnote{\label{fourfoods}Ḍalhaṇa on \Su{1.14.3}{59} said    
    ...
    studies by \citet{oliv-1995,oliv-2001} and the classic reference works
    by \citet{acha-1994,acha-1998}. The long, final adhyāya of the \SS's
    \emph{Sūtrasthāna} (ch.\,46) amounts to a distinct treatise on
food in
    āyurveda.}
...
\se{koṣṭha}{innards}, \se{\root jṝ}{decompose}, being dried in due

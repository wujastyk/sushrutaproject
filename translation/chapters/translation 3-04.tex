...
intestines.\footnote{\Dalhana{3.4.17}{356} discussed this
 ...
 \label{uṇḍuka} The term \dev{uṇḍuka}, “lower intestine, rectum or
anal canal,” is of uncertain interpretation. Ḍalhaṇa said that the
ordinary-language term for \dev{uṇḍuka} was \dev{poṭṭalakā};  see
\cite[177--178]{das-2003} and further references in
...
\subsection{The formation of organs}

\item[25]

The liver and the spleen are produced from blood.  The
\se{pupphusa}{lung} comes from the foam of blood.\footnote{For
    ...
    \volcite{2}[307]{KEWA}).}  The \se{uṇḍuka}{lower intestine} comes from
    an \se{kiṭṭa}{secretion} of the blood.\footnote{On \dev{uṇḍuka}, see
        note \ref{uṇḍuka} above.}

...
But they designate the sleep \se{vaiṣṇavī}{related to Viṣṇu} a
sin.\footnote{Ḍalhaṇa glossed “related to Viṣṇu" as meaning
    \se{māyā}{divine illusion} (\dev{viṣṇoriyaṃ vaiṣṇavī māyeva/}).  The 
    allusion is to Viṣṇu's period of sleep,
    although it is not known why this should be called sinful.}
    %
    By nature, this sleep caresses all living beings.  
    
The sleep called “\se{tāmasī}{of tamas}" occurs when phlegm, which is
dominated by tamas, reaches the \sepl{srotas}{pipe} that convey
consciousness.  At the time of dissolution one does not wake up from
it.  For those who have a lot of tamas, it happens during days and
nights.  For those who have a lot of rajas it happens for no
reason.\footnote{Ḍalhaṇa glossed “for no reason” as “at any time”
    (\dev{aniyatakāle}m that kind of sleep is called “\se{tāmasī}{of
    tamas}." ).} Those who have a lot of sattva, it is at midnight.  For
    those who have diminished phlegm and abundant wind, it is
    \se{vaikārikī}{subject to modification} because of the damage to the
    mind.  % think a bit more about this.

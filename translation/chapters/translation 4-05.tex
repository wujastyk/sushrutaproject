...
\begin{translation}
    ...
    (\dev{uttāna}) and deep (\dev{avagāḍha}).\footnote{Ḍalhaṇa commented 
    \citep[424]{vulgate} that \dev{uttāna} refers to being situated in the skin and 
    flesh, and \dev{avagāḍha} refers to being situated internally.} However, this is 
    not correct.\footnote{In H, the word \dev{tan} should be \dev{tat}.} Why? Just 

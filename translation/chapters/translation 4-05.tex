...
salt, and
    ...
    \item[8]
When bile is predominant,  the physician should make one drink a decoction of \gls{drākṣā}, \gls{ārevata}, \gls{kaṭphala}, \gls{payasyā}, \gls{madhuka}, \gls{candana}, and \gls{kāśmarya}, sweetened with honey. Alternatively, it could be a decoction of \gls{śatāvarī}, \gls{paṭola}, \gls{pattra}, \gls{triphalā}, \gls{kaṭurohiṇī}, \gls{guḍūcī}. Alternatively,\footnote{It appears that \emph{vā} has dropped out of witness H, which is needed to make sense of the syntax here, as seen in the \cite[425]{vulgate}.}  it could be ghee cooked with sweet, bitter and astringent items. There should be an affusion of goat's milk that has a decoction of \gls{bisamṛṇāla}, \gls{bhadraśriya}, and \gls{padmaka}. Alternatively, an affusion with milk, \gls{ikṣu} juice, \gls{madhuka}, \gls{śarkkarā} and rice water; or mixed with a decoction of \gls{drākṣā} and \gls{ikṣu}; or an affusion of ghee cooked with \gls{jīvanīya}, mixed with \se{mastu}{whey} and \se{dhānyāmla}{sour rice-gruel}.
    
    
   %[The patient] should be sprinkled with a decoction of \gls{bisa}, \gls{mṛṇāla}, \gls{bhadraśriya}, and \gls{padmaka} mixed with goat-milk\footnote{The compound word ending with \dev{kaṣāyeṇa} should be read a \textit{bahuvrīhi} for \dev{ajākṣīreṇa} (goat-milk).}, or with rice water that is mixed with milk, sugarcane juice, honey, and sugar, or with whey and sour rice gruel mixed with a decoction of grapes and sugarcane. Or else, [the patient] should be sprinkled with ghee that is prepared with \textit{jīvanīya}\footnote{\textit{Jīvanīya} seems to be a group of medicinal herbs. There is an Ayurvedic preparation called \textit{jīvanīya-ghṛta}. Refer to the \textit{Āyurvedīya Śabdakośa} vol. 1.} or sprinkled with ghee that is purified for one hundred times.

...
%            madana}{Randia dumetorum, Lamk.}{NK \#2091},
  ...
  and ending with
        \item \plant{leadwort}{vidyutśikhānta $\rightarrow$ agni- or
            ...
            1967},\footnote{The plant's name is normally \emph{vidyutśikhā} 
            without the suffic \emph{-anta}.}
        and 
        ...
        addresses the present text and notes specifically that the name is masculine, 
        not feminine.}
        \end{enumerate}
        \end{itemize}

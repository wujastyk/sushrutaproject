...
%    \plant{radish}{mūlaka}{Raphanus sativus, L.}{NK \#2098}es,
    ...
    \plant{`alas, alas'}{hālāhala}{unknown}{Cf. Soḍhalanighantu p.43 (sub
        bola) = stomaka = vatsanābha}, a man turns reddish black, and starts to gasp.
    \item[ 17b]
    With
    \plant{atis root}{śṛṅgīviṣa}{Aconitum heterophyllum, Wall.
    	ex Royle}{AVS 1.42, NK \#39},
    ...
    \item[ 18a]
    With
    \plant{`monkey'}{markaṭa}{unknown}{}, one leaps up, laughs, and bites.
    ...
    %()Experts said that one should know that these thirteen cited highly potent tuber-poisons have ten features:
    %Experts said that these thirteen highly potent tuber-poisons which are mentioned here consist of ten features.)
    \item[ 19b-20a]
   \se{rūkṣa}{dry}, hot, sharp, \se{sūkṣma}{rarified},

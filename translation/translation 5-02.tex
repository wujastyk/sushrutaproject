...
\Su{5.5.30ab}{576}, for the seventh shock of poisoning by a \se{rājimat}{striped
snake}.  It is possible the text migrated from  that location to
this.
...
supported in the Nepalese version.  This therapy seems unknown to the Nepalese
transmission.  Perhaps the therapy migrated into the vulgate \SS\ from the \CS\
\Ca{6.23.66--67}{574}.}

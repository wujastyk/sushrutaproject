...
\begin{translation}
    ...
    \skt{stationary}{sthāvara} and \skt{mobile}{jaṅgama}. The former
    dwells in ten places, the latter has sixteen locations.
    \item[3]
    Traditionally, the ten are: root, leaf, fruit, flower, bark,
    \skt{milky sap}{kṣīra}, \skt{pith}{sāra}, \skt{resin}{niryāsa}, the
    \skt{element}{dhātu}s, and the tuber.
    ...
    \begin{itemize}
        ...
        \#1136},
        \item \plant{sweet-scented oleander}{aśvamāra}{Nerium oleander, 
        L.}{ADPS 
        223, NK
            \#1709},
        ...
        \item \plant{leadwort}{vidyutśikhā $\rightarrow$ agni- or
        ...
        (Mormodica
            ...
            1643; NK \#1520)}, \item \plant{black cardamom}{hareṇu}{Amomum 
            subulatum,
        ...
        \item
        the seven bark, \skt{pith}{sāra} and \skt{resin}{niryāsa} poisons are:
              \begin{itemize}
        ...
        is toxic.}
            \end{itemize}
        \item
        the three \skt{milky sap}{kṣīra}-poisons are:
              \begin{itemize}
        ...
        \item
        the two \skt{element}{dhātu}-poisons are:
              \begin{itemize}
    ...
    \item[7--10]
    Root-poisons cause \skt{writhing}{udveṣṭana}, \skt{moaning}{pralāpa}, and
    \skt{delirium}{moha}.  Leaf-poison is known for causing yawning, writhing
    limbs, and \skt{wheezing}{śvāsa}.  Fruit-poisons cause swelling of the
    scrotum, a burning feeling, and a repugnance for food.  Flower-poisons will
    cause vomiting, \skt{distension}{ādhmāna}, and \skt{delirium}{moha}.  The
    use of bark, \skt{pith}{sāra} and \skt{resin}{niryāsa} poisons will cause
    foul-smelling breath, \skt{coarseness}{pāruṣya}, a headache, and a flow of
    \skt{phlegm}{kapha}.  The \skt{milky sap}{kṣīra}-poisons make one
    ...
    feel heavy.  The \skt{element}{dhātu}-poisons give one a pain in the chest,
...
%
    ...
    \plant{Indian mustard}{sarṣapa}{Brassica juncea, Czern \&
        ...
        defective}{vātavaiguṇya}, there is \skt{constipation}{ānāha}, and
    \skt{lumps}{granthi} start to appear.
    %
    With
    ...
    there is a \skt{discharge}{praseka}, the faeces pour out, and  the eyes
    turn yellow.
    %
    With the
    ...
    one gets violent \skt{knots}{granthi} and stabbing pains in the heart.
    \item[ 18a]
    With
    ...
    said to be \skt{dry}{rūkṣa}, hot, sharp, \skt{rarified}{sūkṣma},
    fast-acting, pervasive, \skt{expansive}{vikāśin}, \skt{limpid}{viśada},
    ...
    \skt{humour}{doṣa}s, \skt{element}{dhātu}s, and the
    ...
    \begin{verse}
        ...
        no longer lethal.  It is surrounded by \skt{phlegm}{kapha} and has an
        ...
        \item[28]
        If it lodges in his \skt{stomach}{āmāśaya}, his wind and phlegm become
        diseased; if it lodges in his \skt{intestines}{pakvāśaya}, his wind and choler
        become diseased.  The man's hair and body are ruined, and he looks like a
        bird whose wings have been chopped off.
        \item[29a-c]
        If it lodges in one of the \skt{body tissue}{dhātu}s such as the
        \skt{chyle}{rasa}, it causes the diseases that were described as arising
        ...
        yawning, \skt{slackness}{viśleṣa} and \skt{exhilaration}{harṣa}, and a
        \skt{chafing of the limbs}{aṅgamarda}. Next, it causes
        \skt{food-mania}{annamada} and indigestion, \skt{appetite-loss}{arocaka},
        \skt{round blotches}{maṇḍala}, \skt{skin disease}{koṭha}, and
        \skt{delirium}{moha}. The body tissues \skt{dwindle away}{kṣaya},
        ...
        or have \skt{irregular fever}{viṣamajvara}.  It may cause heightened,
        powerful thirst.
        ...
        \begin{sloppypar}
            ...
            produce
            madness, while another one may cause \skt{constipation}{ānāha}, and 
            yet
            another may deplete the semen. One may cause slurred speech, while 
            another
            \skt{pallid skin disease}{kuṣṭha}.
        \end{sloppypar}
    \end{verse}
    ...
    it corrupts (\emph{dūṣayate)} the \skt{body tissue}{dhātu}s.  This
    ...
    sore throat.  When the poison reaches the \skt{stomach}{āmāśaya}, it causes
    pain in the \skt{chest}{hṛd}.
    \item[36]
    In the third, the roof of his mouth goes dry, he gets violent \skt{shooting
        pains}{śūla} in the \skt{stomach}{āmāśaya}, and his eyes swell up and go 
        a
    nasty, yellow colour.
    \item[37]
    In the fourth shock, it causes the stomach and intestines to
    \skt{sting}{toda}, he gets hiccups, a cough,  a rumbling in the
    \skt{gut}{antra}, and his head becomes very heavy.
    \item[38]
    In the fifth he dribbles \skt{phlegm}{kapha}, is drained of colour,
    his \skt{joints crack}{parvabheda},  all his humours are inflamed, and he
    also has a pain in his \skt{belly}{pakvādhāna}.
    \item[39a]
    ...
    water. Then he should be made to drink an \skt{antidote}{agada} together
    with honey and ghee.
    \item[41a]
    ...
    \skt{nasal medicine}{nasya} as well as an \skt{eye salve}{añjana}.
    \item[42a]
    ...
    \skt{decoction}{kvātha} of honey and
    ...
    after having a `\skt{crow's foot}{kākapada}' cut made on his head, he
    ...
    \skt{nasal drops}{avapīḍa}, or blowing medicated powder into the nose
    ...
    \begin{sloppypar}
        ...
        \skt{stewed juice}{niṣkvātha} of the following:
        ...
        the \skt{three pungent spices}{trikaṭu} % \marginpar{kaṭu=piquant?}
        ...
        the two \skt{Indian sarsaparillas}{sārive}
    ...
    \label{ajeya}
    There is a famous ghee called \skt{`Invincible'}{ajeya}. It rapidly
    destroys all poisons and `always conquers'. It is made with a
    \skt{mash}{kalka} of the following plants:
    \plant{liquorice}{madhuka}{Glycyrrhiza glabra, L.}{AVS 3.84, NK \#1136},
    ...
    \plant{Indian barberry}{dāruharidrā}{Berberis aristata, DC.}{Dymock 1.65, NK
        \#685, GJM 562, IGP 141}),
    the two \skt{Indian nightshade}{bṛhatī}s
    ...
    %the two \skt{Indian sarsaparilla}{sārive}s
    %  (\plant{country sarsaparilla}{anantā}{Hemidesmus indicus, (L.) R. 
    %Br.}{ADPS 434,
    %    AVS 3.141--5, NK \#1210}
    %  and
    ...
    \begin{sloppypar}
        Someone suffering from `\skt{slow-acting poison}{dūṣīviṣa}' should be well
    ...
    and
    \skt{`gold-chalk' ochre}{kanakagairika}.
    %
    This antitoxin, taken with honey, eliminates `slow-acting poison'. It is
    called `\skt{slow-acting poison antidote}{dūṣīviṣāri}', and there is no
    situation where it is not recommended.
    
    \item[ 53--54]
    If there are any \skt{side-effect}{upadrava}s, such as fever, a burning
    feeling, hiccups, \skt{constipation}{ānāha}, depletion of the semen,
    distension, diarrhoea, fainting, illness in the heart,
    \skt{bellyache}{jaṭhara}, madness, trembling, or others, then one
    should treat each one in its own terms, as well as using the anti-toxic
    medicines.
    
    \item[ 55]
    `Slow-acting poison' is \skt{curable}{sādhya} if caught immediately; it is
    \skt{treatable}{yāpya} if it is of a year's standing; but it cannot be cured
    in someone who has unhealthy habits or who is \skt{weak}{kṣīṇa}.

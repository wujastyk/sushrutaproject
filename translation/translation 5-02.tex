...
% got to here
        ...
        \item[29d--31]
   Listen to its initial \se{liṅga}{symptoms}: sleepiness, heaviness,
        yawning, \se{viśleṣa}{slackness} and \se{harṣa}{exhilaration} and a
        \se{aṅgamarda}{bruising of the limbs}. Next, it causes
        ...
        ringworm.}        
        % got to here.   Next, Deepro 2.31--         
        \se{kṣaya}{dwindling away} of muscles/flesh, swelling of the feet, hands, and face, the fever called \textit{pralepaka}, vomiting and diarrhoea. The slow-acting poison might cause panting, thirst and fever, and it might also cause an increase of the abdomen. 
        ...
        \begin{sloppypar}
            ...
            yet
            another may deplete the semen. One may cause emaciation, while 
            another
    ...
    it may corrupt (\emph{dūṣayet}) the \se{dhātu}{body tissue}s.  This

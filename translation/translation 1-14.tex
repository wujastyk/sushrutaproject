...
\item [3] Food is of four types,\footnote{Ḍalhaṇa on \Su{1.14.3}{59} said
    ...
    lickable, and drinkable (\dev{peyalehyabhojyabhakṣya}). The main text of
    the \CS\ is explicit about these categories, \Ca{4.3.4(1)}{308}:
    \dev{pānāśanabhakṣyalehya/} “things drunk, eaten, chewed or licked.” On
    the distinction of \dev{bhakṣya}/\dev{bhojya}, see \cite{yagi-1994}; for
    further background on foods, see \cite{oliv-2001}.} is endowed with the
    six tastes, made of the five elements, has either two or eight potencies,
    and is endowed with multiple qualities.\footnote{Ḍalhaṇa related these
        qualities to the twenty standard \dev{guṇa} of āyurveda; see, e.g., their
        listing by Vāgbhaṭa, translated by \citet[207]{wuja-2003}.} %
        % \footnote{\dev{anekaguṇopayukta} can
        %        also be understood as “suitable because of possessing many
        % qualities” or
        %        “suitable and possessing many qualities”.}
        Its finest essence, properly transformed, is called chyle. It is of
        the nature of the quality of the fire element. It is situated in the
        heart. From the heart, it enters into the twenty-four arteries—ten
        upward arteries, ten downward, and four sideways—and doing so day
        after day owing to the reaction of past activities that is caused by
        the invisible,\footnote{\dev{adṛṣṭa} (unseen): Doing any righteous or
            unrighteous action produces good merit and demerit respectively. This
            good merit and demerit are called \dev{adṛṣṭa} (invisible) because
            they cannot be directly known but can only be assumed through logical
            deduction.} it satisfies the entire body, enlivens it, prolongs
            it,\footnote{In the sense of prolonging its lifespan} and makes it
                grow. The speed of the entity that flows throughout the body should
                be understood by inference. That speed causes deterioration and
                growth.

...
CS 1.1.73, 1.4.7; Ḍalhaṇa on \VN{4.10.12}{450}.} 
...
\VN{1.6.5}{24} and discussed by \citet[\S\,59]{haya-2017}.}
...
\se{madhūka}{mahua}.\footnote{The expression \se{dravāñjana}{liquid collyrium} 
is only known from 
Ḍalhaṇa's comments on SS.6.17.11ab \citep[626]{vulgate}.  The recipe in the 
present collyrium is different from that discussed by Ḍalhaṇa.}
...
impurity of the \se{kāca}{glassy opacity} because of the \se{añjana}{application
    ...
    Ḍalhaṇa uses this term and phrase in his commentary on Utt.41ab 
    \citep[629]{vulgate}.}
...
made of copper or iron, with a tip like a barley corn that is is held by a steady
...
\se{śalākā}{probe}.\footnote{The anatomy of the eye is described in \VN{6.1.14--16}{596}  
The disks or 
...
\VN{6.19.8}{641}, clearly intending inward sniffing.}
...
sweating to the eye externally, with \se{bhaṅga}{leaves} that remove wind,
after fixing the \se{sūcī}{needle} properly.\footnote{We interpret \emph{bhaṅga}
as leaves, following the usage elsewhere in this sthāna \VN{4.32.9}{513}
A similar procedure is described at \AS{6.17.25}{716} where \emph{bhaṅga} means the 
\se{pallava}{shoots} of the castor-oil plant.}
...
There are two kinds of them (herbs):  stationary and mobile.\footnote{\VN{1.1.28}{7}, tr.\ 
\cite[I, 
21]{shar-susr}.}

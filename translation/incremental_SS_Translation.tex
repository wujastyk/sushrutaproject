...
%    Ḍalhaṇa- sanātha: samitra someone with a friend -->
    ...
    \item [1.28] \saneng{punar}{Thus}, living creatures and their strength, complexion (varṇa) 
    and energy (ojas) are rooted in food.  That (food) depends on the six \saneng{rasa}{flavours}.  
    Next (punar), the flavours depend on \saneng{dravya}{substance}, and substances 

...
Alternatively, one should eat a \se{plīhan}{spleen} and a liver too after
preparing on a spit in ghee and oil.\footnote{We read the locative as if an
instrumental; if the locative were intended then it would be the spit that would
be coated with oil and ghee.}

\item [26]

As is well known, there are the six diseases that can be \se{yāpya}{alleviated}; in 
that case  one should release the blood by bloodletting. 

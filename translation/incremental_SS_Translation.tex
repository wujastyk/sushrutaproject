...
Supplies' chapter.\footnote{Su.1.5.}  And in particular, he should gather
...
(\emph{madhuravarga}) are enumerated at Su.1.42.11.} and
...
The wise man who been sweated should rub it into to the ear that has been 
\se{mardita}{massaged}.  Then it will be free of complications, and
will enlarge properly and be strong.
\end{sloka}

...
Alternatively, experts on this say that finely ground \se{tuttha}{copper sulphate}
...
\emph{Sauśrutanighaṇṭu} specifies the Uḍumbara (252).}
...
\se{jāṅgala}{arid-land animals}\footnote{On this term, see
\cite{zimm-jung}.}\q{check ref.} and a plentiful amount of \se{māgadha}{long
...
urine\footnote{}\q{find ref.} is put into water with the three fruits. Having
...
SS it is more commonly interpreted as a spirit or demon.} one should place it in a

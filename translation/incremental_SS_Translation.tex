...
\newcommand{\AS}[2]{AS\,#1 \citep[#2]{atha-1980}} % references to the Saṅgraha, 
% #1 = canonical
% #2 = page of Aṭhāvale's edition

\newcommand{\Ah}[2]{Ah\,#1 \citep[#2]{kunt-1902}} % references to the Saṅgraha, 
% #1 = canonical
...
pressed properly on the eye,\footnote{We understand the locative \emph{nayane} as
the place of pressing; other interpreters take it as an accusative dual.  The idea is that the 
eye is held steady by the surgeon.} at the
\se{daivakṛte}{naturally occurring} \se{chidra}{hole}.

The 
\se{śalākā}{probe} is made of compper or iron and has a tip like a barley corn.
It is held by a steady hand with the middle finger, forefinger and thumb,
...
\se{śalākā}{probe}.\footnote{The anatomy of the eye is described in \SS{6.1.14--16}{596}  
The disks or 
...
\SS{6.19.8}{641}, clearly intending inward sniffing.}

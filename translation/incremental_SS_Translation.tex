...
\item[32]
 ...
 \dag A \se{puṭākhya}{furnace} is done 
with Sindh salt and a \se{kravyabhuj}{carnivore},\footnote{The declension of 
\emph{kravyabhuj} is incorrect here.}
honey and ghee, combined with what comes from meat.\footnote{This verse 
seems to contain irresolvable difficulties, but there are no significant variants in the 
Nepalese MS transmission.  The vulgate reads substantially  
differently.}\dag

\se{vasā}{Fat} from a horse, a vulture, a snake, a \se{tāmracūḍa}{cock}, combined
with \se{madhūka}{mahua} is always good in a collyrium.
   ...
   meat soups of various animals \citep[628]{susr-trikamji3}.}

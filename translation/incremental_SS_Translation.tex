...
In 1939, Yādavaśarman Trivikrama Ācārya co-edited an edition of the
...
\cite{hofe-2007}. See also the remarks on this edition by \citet[7]{kleb-2021a}.}  
...
of the text (see Figure~\ref{fig:bhanumati-page-11}). The text was edited on the basis of 
the 
following sources.
...
\begin{enumerate}
    \item A printed edition.  Had the
\emph{Bhānumatī} up to chapter Su.sū.40.  The siglum was \dev{mu} for 
\emph{mudrita}.\footnote{\cite{sena-1893}.  The
...
Bhandarkar Oriental Research Institute in Pune.  At this time, manuscripts
from London were routinely lent to scholars in India. This manuscript had the
\emph{Bhānumatī}, up to the end of the \emph{sūtrasthāna}.  The siglum was 
\dev{ha} for \dev{hastalikhita}.\footnote{\MScite{London BL H. T. Colebrooke
908} (\href{panditproject.org/entity/109978/manuscript}{PanditProject
\#109978}, consulted on July 03, 2021).}
    \end{enumerate}

\subsubsection{For the Suśrutasaṃhitā}

\begin{enumerate}
    \item Palm leaf MS from Hemarājaśarman's library, i.e., \MScite{Kathmandu NAK
    5-333}.  The siglum was \dev{tā} for \dev{tāḍapatra}.

\item His own published edition. The siglum was \dev{ḍa} for \dev{ḍalhaṇasaṃmataḥ
    pāṭhaḥ}.\footcite{susr-trikamji3}
...
commentary all came together with the root-text of the \SS, and thus the main
\SS\ text reflected the readings chosen by Ḍalhaṇa.  But the manuscripts of the
...
manuscript.\footnote{\cite[3--4]{acar-1939}.  See discussion by \citet[7]{kleb-2021a}.}

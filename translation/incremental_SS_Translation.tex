...
honey
and ghee.\footnote{On the \emph{puṭa} process in the 
\emph{Suśrutasaṃhitā}, 
which is earlier and different than that of \emph{rasaśāstra} literature, see the 
discussion by  \citet[83]{wujad-2019}: \begin{quote}
...
\end{quote} 
The process is described SS.6.18.33--38 \citep[635]{vulgate}.}

\se{vasā}{Fat} from a horse, a vulture, a snake, and a \se{tāmracūḍa}{cock}, 
combined
with \se{madhūka}{mahua} is always good in a collyrium.\dag\footnote{This 
...
substantially differently but we have nevertheless made emendations in line with it
and read the verse as two sentences.}

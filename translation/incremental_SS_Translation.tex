...
\item[6] 
One should treat the properly-pierced ear by sprinkling it raw sesame oil.   After 
every three days one should apply a thicker \se{varti}{wick} and sprinkle oil right on 
it.\footnote{The manuscripts support 
the reading \emph{sthūlatarīṃ} that is either a non-standard form or a scribal error.}

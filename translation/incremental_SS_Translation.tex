...
\documentclass[12pt,
 %    draft,     %taking out draft switches off marginal notes and on pictures
    ]{book} 
...
% some conditional shortcuts for working on specific chapters
\newif\ifkalpa
\newif\ifsarira
%\kalpatrue
%\sariratrue
%
\ifkalpa  \includeonly{%  this is all a bit pointless, but still.  I'll get rid of it later.
...
%    chapters/bibliography and indexes
    ...
    \fi
\ifsarira \includeonly{chapters/translation 3-02,
    chapters/bibliography and indexes
    } 
    \fi        
% end of conditionals

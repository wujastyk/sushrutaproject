...
from the pores on the head where \se{granthi}{lumps} appear. In such a case, 
one
should repeatedly apply an ointment of black earth soaked with
bear's bile,\label{fluidbile}\footnote{Ḍalhaṇa comments here
...
\Su{5.1.57}{562}.}\q{Bear's bile instead of deer's bile.}
ghee,
\se{śyāmā $\rightarrow$ priyaṅgu}{`going-to-my-darling'} %{Callicarpa 
%macrophylla,
% Vahl.}{AVS 1.334, NK \#420},
%\se{pālindī $\rightarrow$ trivṛt, ḍalhaṇa}{turpeth} %{}{}
\se{pālindī}{black creeper},\footnote{These plant identifications are based on 
Ḍalhaṇa's glosses.}
%{Ichnocarpus frutescens, (L.) R.Br. \textnormal{or}
% Cryptolepis buchanani,
%Roemer \& Schultes}{AVS 3.141, 3.145, 3.203, NK \#1283, \#1210, ADPS 434},
and \se{taṇḍulīyaka}{amaranth}. %{Amaranthus hypochondriacus, L.}{King 
%321, NK
...
the juice of \se{mūṣikaparṇī $\rightarrow$ dravantī}{purging nut}, %{Jatropha

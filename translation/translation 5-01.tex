...
%\plant{wild asparagus}{bahuputrā}{Asparagus racemosus, Willd.}{ADPS 441, 
%AVS 1.218, NK \#264, IGP 103,
%    IMP 4.2499ff., Dymock 482ff.}
%\skt{juice}{svarasa} and ghee, mixed with honey. Very cold
%\plant{white cutch tree}{somavalka}{Acacia polyacantha, Willd.}{AVS 1.30, IGP
...
\newcommand{\skt}[2]{\se{#2}{#1}}

When poison is mixed in with \skt{eye make-up}{añjana}, he gets \skt{rheumy
    tears}{aśrūpadeha}, with a burning feeling, pain, bleary vision, and
possibly even blindness.  In this case, one must immediately drink ghee and
apply a \skt{balm}{tarpaṇa} of
\plant{long pepper}{māgadha}{Piper longum, L.}{NK \#1928; but cf.\ AVS
    3.245}, and
% \plant{needle-flower jasmine}{māgadha}{Jasminium auriculatum, Vahl.}{AVS
% 3.245, but cf.\ NK \#1928 etc.}
have an \skt{eye ointment}{añjana} prepared out of the juice of
\plant{periploca of the woods}{meṣaśṛṅga}{Gymnema sylvestre (Retz.)
    R. Br.}{AVS 3.107, NK \#1173}, and the \se{niryāsa}{resin} of 
\plant{three-leaved caper}{varuṇa}{Crataeva magna (Lour.) DC.}{AVS 2.202;
    cf.\, NK \#696}.
%and the \skt{resin}{phena}\footnote{Skt.\ \emph{phena} is
%normally translated as `foam' or `froth', but must be `resin' or `sap' here
%because of the context and the known medicinal use of white dammer
%(\emph{Vateria indica, L.}).} of
%\plant{weaver's beam tree}{muṣkaka}{Schrebera swietenioides, Roxb.}{AVS 
%5.88,
%    Lord, NK \#2246} and
%\plant{white dammer tree}{ajakarṇa}{Vateria indica, L.}{NK \#2571, AVS 
%5.349f.,
%    IMP 1.292f., GIMP 253a}, mixed with \skt{cow's
%    choler}{gopitta}.\footnote{`Cow's choler', \emph{gopitta}, is glossed by
%ḍalhaṇa as \emph{gorocanā}, which might be interpreted as bezoar.} Or it
%could be made separately out of the flowers of
%\plant{wood apple}{kapittha}{Limonia acidissima, L.}{AVS
%    3.327, NK \#1021}, or
%\plant{periploca of the woods}{meṣaśṛṅga}{Gymnema sylvestre (Retz.)
%    R. Br.}{AVS 3.107, NK \#1173}, or
%\plant{marking-nut tree}{bhallātaka}{Semecarpus anacarium, L.}{NK
%    \#2269, AVS 5.98}, or again out of
%\plant{`kinsfolk'}{bandhūka}{Pentapetes phoenicea, L.}{NK \#1836} and
%\plant{sage-leaved alangium}{aṅkoṭa}{Alangium salvifolium,
%    (L. f.) Wang.}{AVS 1.77; cf.\, NK \#88}.

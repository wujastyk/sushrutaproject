...
%28
Flies or crows or other creatures that are made to eat 
a \se{bali}{morsel} that they have been given of some
poisonous food from the king's portion, die on the spot. 

\item [29] 
Such food
makes a fire crackle violently, and gives it an overpowering colour like a peacock's
throat. 
...
\animal{pheasant peacock}{jīvajīvaka}{?}{?} drops dead.  A
\animal{koel}{kokila}{Eudynamys scolopacea}{Collins 66} changes its song and the
\animal{common crane}{kroñca}{Grus grus}{Collins 47} rises up excitedly.  It will 
excite a \animal{peacock}{mayūra}{Pavo cristatus}{Collins 39}, and the 
terrified \animal{parakeet}{śuka}{Psittacula krameri\slash
    eupatria\slash cyanocephala}{Collins 64} and the \bird{hill
    myna}{sārikā}{Acridotheres tristis tristis, L., etc.}{Ali \#1006,
    \citet[28\,ff.]{Dave}, \citet[119]{Collins}} screech. The
\animal{swan}{haṃsa}{?}{?} hisses a lot, and the \animal{racket-tailed
    drongo}{bhṛṅgarāja}{Dicrurus paradiseus}{Collins 123} shrieks. The
\animal{chital deer}{pṛṣata}{Axis axis, Erxleben}{BIA 292, IW 93} sheds
tears and the monkey opens its bowels.

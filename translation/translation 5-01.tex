...
\diff{people who are not his friends}.\q{opposite of the vulgate Same as
    \As{1.8.89}{79}.}\footnote{The \emph{Carakasaṃhitā} described `protecting the
    heart' as drinking several sweet, oily drinks to surround the heart and keep
    it safe (\Ca{6.23.46}{574}).  Ḍalhaṇa explained it as taking a number of
    anti-toxic medicines, including those listed in the present passage, in order
    to cover or hide (\dev{pracchādana}) the heart \Su{5.1.79--81}{563}.} Before
...
%        Reptiles}, 58}s,
\gls{pṛṣata}, %{Axis axis, Erxleben}{BIA 292, IW 93},
and \gls{hariṇa} too, %{Antilope cervicapra, L.}{BIA 270},
...
\gls{pālindī},\footnote{Or some say turpeth.}

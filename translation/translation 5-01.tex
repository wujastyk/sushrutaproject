...
indicated\q{The two uses of prāpta are hard to translate.  prāptāḥ $\rightarrow$
    ...
    sense of
    a difficult passage.} veins pierced.\q{\root vyadh not \root vedh (also elsewhere
...
(\Su{5.1.78}{563}) cited a description of the two plants from the little-known
authority Uśanas \citep[IA, 660 et passim]{meul-hist} that described 
\dev{ajaruhā}
...
people
who are not his friends.\q{opposite of the vulgate Same as 
\As{1.8.89}{79}.}\footnote{The
\emph{Carakasaṃhitā} described `protecting the heart' as 
drinking
several sweet, oily drinks to surround the heart and keep it safe
(\Ca{6.23.46}{574}).  Ḍalhaṇa explained it as taking a number of anti-toxic 
medicines, including those listed in the present passage, in order to cover or hide 
(\dev{pracchādana}) the heart \Su{5.1.79--81}{563}.} Before 
eating he should drink the kinds of ghee called
...
He should consume monitor lizard, peacock, mongooses, %{Varanus bengalensis,
% Schneider.}{\emph{Book of Indian
%        Reptiles}, 58}s,
\se{pṛṣata}{chital deer}, %{Axis axis, Erxleben}{BIA 292, IW 93},
and \se{hariṇa}{blackbuck} too, %{Antilope cervicapra, L.}{BIA 270},
that destroy poison, and their juices.
...
%{Aconitum heterophyllum, Wall. ex Royle}{AVS 1.42, NK \#25}
to peacock flesh, together with
...
\item[84ab]
A cold neem\q{Medical difference.} broth with honey and ghee is wholesome too. 

\item [84cd]

A discerning person should partake of hard and soft foods that counteract
poison.\footnote{On this expression, Yagi, T. 1994. A Note on bhojya- and 
bhakṣya-. In: A Study of the Nīlamata. Aspects of Hinduism in Ancient Kashmir. Y. 
Ikari (ed.).}

\item [85]

If poison might have been drunk, a person who has protected his heart 
should make himself vomit using long pepper, liquorice, honey, sugar, 

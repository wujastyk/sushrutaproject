...
the same as for \se{abhyaṅga}{massage}.
 ...
 When a comb has poison in it, the hair falls out, the head aches, and
 blood oozes from the pores on the head where \se{granthi}{lumps} appear. In 
 such a case, one should repeatedly apply an ointment of black earth
 soaked with \se{ṛṣyapitta}{antelope's 
 choler},\label{fluidbile}\footnote{Ḍalhaṇa
  comments here that `choler is that fluid which goes along inside the tube 
  attached
  to the liver' (\dev{kālakhaṇḍa\-lagna\-nalikā\-madhya\-gata\-jalaṃ
   pittam}) \Su{5.1.57}{562}.}
 ghee,
\se{śyāmā $\rightarrow$ priyaṅgu}{`going-to-my-darling'} 
%{Callicarpa macrophylla, Vahl.}{AVS 1.334, NK \#420},
 ...
 and
 \se{taṇḍulīyaka}{amaranth}.
 %{Amaranthus hypochondriacus, L.}{King 321, NK \#144, Potter 15.  Cf.\ AVS 
 % 1.121}.  
 Good alternatives are either the fluid extract of cow-dung, or the juice of
 \se{mālatī}{jasmine},
 %{Jasminium grandiflorum, L.}{NK \#1364},  
 the juice of \se{mūṣikaparṇī $\rightarrow$ dravantī}{purging nut},
 %{Jatropha curcas, L.}{AVS 3.261, NK \#1374},
 or some soot from the chimney.

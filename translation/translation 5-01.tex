...
\emph{indrāgopā} before him, and he tries to explain \dev{indrā} and \dev{gopā} as
...
the \se{somalatā}{soma creeper}, which might explain his choice to take the word as
feminine.  But the compounded word is far more likely to be \dev{soma} (m.), the
well-known mystery plant \citep[see][76--78, 125]{wuja-root3}.  If this can be
...
herself by eating Rue, against the might of the serpent.” Cited from
\cite[262]{wren-1956}; not found in \cite{osba-dios}.}
    ...
    \end{translation}
\newpage
Our thinking about indragopa is wrong \parencites[99]{lien-1978}[22]{dave}.

\citet{lien-1978} has redefined our thinking about indragopa.
...
\cite{lien-1978,dave}
   ...
   Ḍalhaṇa on \Su{1.6.99}{345}
   
   This and that.\footnote{\cite{lien-1978}.}
   
     This and that.\footcites[As argued by][]{lien-1978}

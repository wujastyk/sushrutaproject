...
and \se{punarnavā}{hogweed}.\footnote{The common name \dev{punarnavā} 
is read as
\dev{punarṇṇavā} in both Nepalese witnesses.  This unusual form is
technically-speaking legal according to Pāṇini 8.4.3, but is not attested in
published texts.  It is found rarely in some other Nepalese manuscripts such as
the \emph{Brahmayāmala} (a.k.a.\ \emph{Picumata}, 44.81, transcription thanks 
to
Shaman Hatley).}\q{punarṇṇavā in the N \& K MSS} %{Boerhaavia
%diffusa, L.}{ADPS 387, AVS
%1.281,NK \#363}.
 
\item[62ab] 

Elephants and the like become ill and they they dribble saliva. And the rider gets
...
rider\q{yatri- for yatṛ} and the mount.

...
\begin{quote}
    The signs of a poisoner, on the other hand, are as foll.  Please write back to the 
    library with this request, and CC me.ows: dry and
...
\se{pratipūraṇa}{refilled} promptly with ghee and honey.  
\se{svarasa}{Extracted
    juice} of \se{bahuputrā}{wild asparagus} and  very cold juice of
\se{somavalka}{white cutch tree} is\q{are? genders?} also  recommended as 
something good.
...
When poison is mixed in with \se{añjana}{eye make-up}, he gets
\se{aśrūpadeha}{rheumy tears}, with a burning feeling, pain, bleary vision, and
...
\se{pāka}{sepsis}, and \se{avadāraṇa}{fissuring}.

\item[75ab]

One should apply the procedures for \se{abhyaṅga}{massage oil} to what has 

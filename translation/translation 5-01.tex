...
rapidly stink and unripe ones ripen.\q{fn on prakuth. Lexeme known only in SS.}
...
\item[49]
 ...
 \item[50] Alternatively, the roots of \se{aṅkolla}{sage-leaved alangium}, barks
of \se{saptachada}{blackboard tree} or \se{śirīṣa}{siris} and 
\se{māṣaka}{mung
    beans}.  The  \se{pratisāraṇa}{rubbing} should be done.\footnote{The 
    spelling of
the name \dev{aṅkolla} varies \dev{aṅkoṭa, aṅkoṭha, aṅkola} 
\citep[5]{sing-1972};
Ḍalhaṇa notes that the present form is colloquial.   The sentence is awkward and 
we have emended \dev{śirīṣamāṣaka} to be a plural rather than an ablative, in 
line with the vulgate text.}

\item[51ab] 
 
In the case of a poisoned tongue scraper or \se{kavala}{mouthwash}, the
same treatment is recommended as for the toothbrush twig.
...
When the massage oil has been contaminated with poison, it causes boils, pain, a 
\se{srāva}{discharge}, inflammation of the
skin, and sweating.\footnote{The feminine \dev{sphoṭā} for “boils” is 
unattested.} And the \se{māṃsa}{muscles} have \se{dāraṇa}{ruptures}.

\item[53]

In such a case, an \se{anulepana}{ointment} should be made of something 

...
\emph{tagara} is Indian Valerian, but there remain many historical questions 
about
the ancient identity of \dev{tagara}.} costus, and \se{uśīra}{vetiver grass},
\se{veṇupatrikā}{bamboo leaves} , \se{somavallī}{heart-leaved moonseed} and
\se{amṛtā}{calamine lotion} \se{śvetā}{white clitoria}, \se{padma}{sacred 
lotus},
and \se{kālīyaka}{Indian barberry} should be made into an 
\se{anulepana}{ointment}
for the patient who has been sprinkled with cold water. That is also recommended
as a drink with the juice and leaves of \se{kapittha}{wood apple}.\footnote{This
compound could be interpreted as “wood apple juice and \se{patra}{cassia
cinnamon}.”  Note that this recipe is differs from that of the vulgate, which
requires urine.}

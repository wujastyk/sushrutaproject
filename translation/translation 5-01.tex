...
The \se{voḍhāra}{bearers}, chefs for the soups, boiled rice and cakes and whoever
else might be there, must all be under the strict control of the
doctor.\footnote{The word \dev{sūpodanapūpika} “chefs for the soups, boiled rice
and cakes” is grammatically interesting.  The \dev{sūpodana} (as opposed to
...
p.\,43]{hoer-bowe}.} % 2.11.54 supodana in the Bodh. (from Einoo's cards)
% sūpodana kṣīrodana
% Bower MS 328

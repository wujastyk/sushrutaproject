...
short \dev{a-} ending.  Gayadāsa and, following him, Ḍalhaṇa, noticed that some
manuscripts read \dev{aṣṭhīla} with a short \dev{-a} ending.  The vulgate
reading “\sed{cāsyāt}{from his mouth}” is easier (\emph{lectio facilior}), but is 
not attested
in the Nepalese manuscripts.} In such a case, he should apply the treatment
prescribed above for vapour, and what will be stated below under “toothbrush

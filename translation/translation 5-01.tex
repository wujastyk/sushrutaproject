...
\se{pṛṣata}{Chital deer}.  The reading \dev{vṛṣabha} is easy to read as
\dev{pṛṣata} in the Newa script.}

\item[34]

Vapour rising out of food which has been served up gives rise to a pain in the
heart, it makes the eyes roll, and it gives one a headache.

...
In such a case, an errhine and a collyrium that are costus, \se{lāmajja}{lāmajja
    grass}, \se{nalada}{spikenard} and \se{madhus}{liquorice};\footnote{The vulgate 
...
\dev{madhus}  of the Nepalese
manuscripts is less common than neuter \dev{madhu} “honey, sweetness,
liquorice”.}

\item[37]

Reaching the hands, it makes them burn, and the nails fall out. In such a case,
\se{pralepa}{ointment} is made of
\se{śyāmā}{beautyberry}
%{Callicarpa macrophylla, Vahl.}{AVS 1.334,    NK \#420},
\se{indragopā}{lac}
%{Kerria lacca    (Kerr.)}{http://www.icar.org.in/ilri/de fault.htm},
\se{somā}{`gentle'}
%{Ruta graveolens, L., or Sarcostemma brevistigma, W \& A, etc.}{NK \#2179, 2228; Potter 
%262},
% \footnote{Some say that Somā is Rue.  `Dioscorides writes that `it is
% reported that if a man be anointed with the juice of the Rue, [serpents,
% scorpions, bees, hornets and wasps] will not hurt him, and that the serpent
% is driven away at the smell thereof when it is burned; insomuch that when
% the weasel is to fight with the serpent she armeth herself by eating Rue,
% against the might of the serpent'.\,' -- \emph{Potter}, p.\,262.}
and
\se{utpala}{water-lily}.%
%{Nymphaea stellata, Willd.}{GJM 528, IGP 790; Dutt 110, NK \#1726}
\footnote{“Beautyberry” (\emph{Callicarpa macrophylla} 
    Vahl.) is one identification of \emph{śyāmā}, but vaidyas and commentators have 
    different ideas about the plant's identity (see \cites[410]{sing-1972}[1: 

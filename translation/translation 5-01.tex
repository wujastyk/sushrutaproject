...
him pallid and thin.
 ...
 In such a case, the dry fruit of \se{nīlinī}{indigo}, %{Indigofera tinctoria,
% L.}{NK \#1309},
purgation with ghee and the `\se{dūṣīviṣāri}{slow-acting poison antidote}'
...
poison' is discussed at \Su{5.2.25\,ff.}{565}.}
     ...
     Also, no reflections are visible, or if they can be seen, they are distorted,
fractured, or tenuous and distorted.\footnote{Both Nepalese witnesses read
\se{vikṛta}{distorted} twice, which seems tautologous.  The scribe,
apparently the original hand, has added in the margin \se{yamalā}{double}, as
in the vulgate, but this addition does not scan, so the scribe must be offering it
as an alternative, not an insertion. We retain the \emph{lectio
difficilior}.}
...
All edibles have no smell, colour or taste.  Ripe fruits
...
\item[49]
 ...
 \se{chebulic myrobalan}{harītakī}

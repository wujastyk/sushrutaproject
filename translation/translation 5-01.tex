...
follow Ḍalhaṇa's glosses, although he note a difference of opinion on the identity 
of \se{mūṣikakarṇī}{mouse-ear}.  \cites[317]{sing-1972}[23--25]{adps} discuss 
this issue well.
\par
The expression \dev{dhūmo āgārasaṃjñitaḥ} `the smoke termed ``house''\,' is 
commonly interpreted by translators and in Ayurvedic dictionaries as `household 
soot.'  The term is comprehensively discussed by \citet[443]{meul-2008}.} 
 
 
 \item[59]
 
 If either massage oil for the head, or a helmet for the
 head, in a wash, turban, or garlands that are contaminated with poison, then 
 one should treat it in the same way as a comb.
 
 \item[60--61]
 
 When face make-up is poisoned, the face becomes dark and has  the symptoms 
 found
with poisoned massage oil. It is covered with 
\se{kaṇṭaka}{spots} that are like 
\se{padminīkaṇṭaka}{lotus-spots}.\footnote{See the description of this condition
\Su{2.13.40}{323}, where the skin on the face is characterized as having pale
circular patches that are itchy and have spots.}  In this case, the drink is honey 
and ghee, and the
\se{pralepa}{ointment} is sandalwood %{Santalum album, L. %}{ADPS 111, NK 
%%\#2217}
with
ghee, \se{payasyā}{curds}, honey, \se{phañjī}{verbena} %{Clerodendrum 
%serratum,
% L.}{AVS 2.121, ADPS 87},
and \se{bandhujīva}{scarlet mallow} %{Pentapetes phoenicea, L.}{NK \#1836},
and \se{punarnavā}{hogweed}. %{Boerhaavia diffusa, L.}{ADPS 387, AVS 
%1.281,NK \#363}.

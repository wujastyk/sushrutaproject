...
\se{soma}{`gentle'} and \se{utpala}{water-lily}.%
%{Nymphaea stellata, Willd.}{GJM 528, IGP 790; Dutt 110, NK \#1726}
\footnote{“Beautyberry” (\emph{Callicarpa macrophylla} Vahl.) is one
identification of \emph{śyāmā}, but vaidyas and commentators have different ideas
about the plant's identity (see \cites[410]{sing-1972}[1:
334]{avs}[\#420]{nadk-1954}).  On translating \emph{indragopa} as “velvet-mite,”
see \cite{lien-1978}. Ḍalhaṇa curiously parses the name \dev{somā} (f.) from the
compound; this feminine noun is almost unknown to Ayurvedic literature.  Some
...
the \se{somalatā}{soma creeper}.  The compounded word is more likely to be
\dev{soma} (m.), the well-known mystery plant \citep[see][76--78,
125]{wuja-root3}.  If this can be taken as rue (\emph{Ruta graveolens}, L.), as
some assert, one can point to a pleasing passage in Dioscorides where rue plays an
antitoxic role: “\ldots it is a counterpoison of serpents, the stinging of
Scorpions, Bees, Hornets and Wasps; and it is reported that if a man be anointed
with the juice of the Rue, these will not hurt him; and that the serpent is driven
away at the smell thereof when it is burned; insomuch that when the weasel is to
fight with the serpent she armeth herself by eating Rue, against the might of the
serpent.” Cited from \cite[262]{wren-1956}; not found in \cite{osba-dios}.}
     
     \item [38--39]
     If he eats that food, by mistake or through ignorance, then his tongue will feel
     like a \se{aṣṭhīlā}{ball of stone} and it will lose its sense of taste.
     It stings and
     %\sskt{stings}{tudyate},
     burns, and his \se{śleṣman}{saliva}\label{saliva} dribbles out.\footnote{The vulgate 
     reading \sed{cāsyāt}{from his mouth} seems much more likely, but is not attested in the 
     Nepalese manuscripts.}
     In such a case, he should apply the treatment prescribed
     above for vapour, and what is stated below under “toothbrush twigs.”

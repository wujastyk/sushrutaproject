...
\emph{\footnotesize The first layer of the apparatus gives the variants of the Nepalese MSS
...
\pstart
\footnoteA{MSS K, H, and N}athātaḥ 
...
}\footnoteD{The \emph{ātmanepada} participle is a permitted 
form, 
although the vulgate 
has the 
...
} taddeśaviddhaliṅgam\edlabel{SS.1.16.4--6} \edtext{||3||\footnoteA{From here, witness K 

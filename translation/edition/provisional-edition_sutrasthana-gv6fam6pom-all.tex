...
\usepackage{provisional-edition} % all the TeX setup is in provisional-edition.sty
...
}\footnoteD{The \emph{ātmanepada} participle is a permitted form, although the vulgate 
has the 
...
\pstart
 atha\edlabel{SS.1.16.8--1} vyapagatadoṣopadrave \edtext{karṇṇe}{
  \Afootnote{\add\  laṃ N; \add\  lam H.}
} pravarddhanārthaṃ \edtext{laghupravarddhanakām}{\lemma{laghu°}
  \Afootnote{\uwave{la}° N.} 
   \lemma{°pravarddhanakām}\Dfootnote{°vardhanakaṃ A.} 
} āmuñcet\edlabel{SS.1.16.8--6} \edtext{||7||}{
  \linenum{|\xlineref{SS.1.16.8--6}}\lemma{āmuñcet}\Dfootnote{kuryāt  A.}
}
\pend\bigskip
...
}\footnoteD{Cakrapāṇi (1.16.9–13) and Ḍalhaṇa (1.16.10) 
...
\emph{vṛttāyatasamobhayapālir}) and others do not read \emph{saṃkṣiptādayaḥ 
    pañcāsādhyāḥ}.} tad yathā | nemīsandhānakaḥ\edlabel{SS.1.16.10--9} \edtext{|}{
...
}yuktā na siddhim upayānti ||9||\footnoteD{The vulgate passage inserted between 9 and 10 
(from

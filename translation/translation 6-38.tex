...
\item [6.2] And similarly there are other (kinds of morbid female reproductive 
...
\item [19]
One should treat a \se{yoni}{female genital}  that is rough, cold, rigid and lacking in sensation with \se{kumbhīsveda}{pot-sweat}%
	\footnote{%
...
\item [21]
One should also apply wholesome cleansing as well as emesis. 
...
\item [22]
A physician should fill \se{yoni}{?} that has a bad smell, or also the one that is 
slimy, with powders prepared from the decoction of five substances. And in these 
conditions, the cleansing substance is the decoction made from royal tree and 
other substances.

\item [23]
As for conditions connected with \se{yonikrimi}{worms in the vagina}, a 
physician should slowly fill it with pastes containing cleansing substances, cow 
urine and sea salt.  

...
She overindulges in \se{grāmyadharma}{sex} because of \se{atyānandā}{excessive enjoyment} and dissatisfaction.%
...
\item[13]
During \se{maithuna}{sexual intercourse}, the first \se{caraṇī}{?} she surpasses the man.
	%TODO add a footnote that we can actually infer that Ḍ read exactly what the \Nep read.
	%TODO add Ḍalhaṇa who says that she is excited more WHILE Madhukośa (who actually thinks that she is a-caranā etc. ) says that she does not enjoy sex as much as the man does 
...
Because of frequent excessive intercourse, the \se{bīja}{semen} then does not stay in place.
	...
	%%TODO add footnote: Madhukośa reads ``tayor'' here and says that in both kinds bīja doesn't stay.

...
mixed with sweet drugs in the \se{yoni}{vaginas}. And the women should gently hold enough \se{balā}{Country Mallow} oil.%
	%todo add a footnote explaining what is happening

\item [24]
One should also apply suitable types of lavage as well as vomiting. 
In diseases with \se{ūṣā}{burning sensations}%
	\footnote{%
	In the provisional edition of the verse, we chose the reading \textit{ūṣā} that is preserved here by \MScite{Kathmandu KL 699}. Although \MScite{Kathmandu NAK 5-333} transmits here a more common orthography of the word (namely, \textit{uṣā}), it attests to \textit{ūṣā} at another instance, in SS.Ci.2.22.%
	} 
and \se{coṣa}{heat}, a physician should apply cold treatment that has been taught.
...
One should slowly fill a \se{yoni}{vagina} that has \se{yonikrimi}{vaginal worms} with pastes made of purifying substances with cow urine and sea salt.
    % śodhanadravya are listed in Sū.37.12-20 (miśrakādhyāya...)
    % kalka with śodhanadravyas are in vs. 15
    % varti with śodhanadravya is also here

\item [27]
Or, one may fill it with the paste of the \se{bṛhatīphala}{Indian Nightshade}, having washed it with its liquid.%
    \footnote{%
    %todo, we think, tadambu = -kalkāmbu.
    } 

However, one should fill and fumigate it when itchy and numb.% \se{yoni}{vagina}.

%\se{niḥsparśa}{lacking in 
%sensation} with the water of \se{bṛhatī}{Indian barberries} and fill it with pastes 
%made of them. He should also fumigate it.
%TODO discuss my emendations
...
%%%could not perform these operations on female private parts.
%%%% SAME thing about {prasraṃsanī} and the change svinnā<>svinnāṃ
%
%TODO think here also of dhārayeyuḥ and write a footnote afterwards
%
% should dhūpayet also go with kalkaiḥ ?!


\item [28]
Wicks with purifying substances should be administered in the case of \se{karṇinī}{}.

One should anoint the \se{prasraṃsanī}{} with ghee, sweat it and enter milk 
into it. 
%TODO @@discuss the change between svinnā>svinnām noted above
%% @@ At any rate, my choice of assigning the pradhāna- and the gauṇa- karma 
%%(i.e., prayojitakartṛ = ex-svatantra) is more or less random. 
%todo CHANGE to svinnā !!!

\item [29] 
And then, a physician should cover it with \se{veśavāra}{} and make a bandage. 
And for each \se{doṣa}{humour}, one should place/ prescribe 
SURĀRIṢṬASAMĀM/N.
...
\se{stanya}{breast-milk} and the diseases of \se{rasa}{chyle} have been explained, and the causes for impotence and the treatment of miscarriage. 

...
\MScite{Kathmandu NAK 5-333} had acess to further textual sources or whether 
...
In the case of \se{ṣaṇḍhī}{?},%
	\footnote{%
	It is noteworthy that both MSS equally unambigous in trasnmitting \textit{ṣaṇḍhī} as the name of the condition here, and calling it \textit{śaṇḍhī} in the list above (see verse 8). At the moment we preserve this orhographic variation in our provisional edition and in the translation. Note, furthermore, that in our printed sourses of the verse (\cite{vulgate} and @@\textit{Mādhavanidāna}@@) that condition is caleld \textit{ṣaṇḍī}.%
	} 
...
and during sex, it is rough to the touch.
	%TODO think of a possiblity not changing ṢAṆḌHYĀ > because of
...
may become \se{aṇḍanī}{?}.%
	...
	@@MN@@ reads \textit{aṇḍalī} and reports \textit{aṇḍiṇī} as the reading of the MS `\textit{ka}'. It seems likely, furthermore, that the latter reading was the one presupposed by Śrīkaṇṭhadatta 
	%TODO add MN to bibliography
	%TODO add info about `ka' 
	}
	%TODO add a note that in Maithilī aṇḍanī ~ aṇḍalī
	%TODO add a note in Ḍalhaṇa's text it is phalanī OR a-phalanī
	...
	%TODO Madhukośa: aṇḍalī [!] aṇḍavan niḥsṛtā yoniḥ 
		%% It seems likely that MK actually read aṇḍanī, or aṇḍinī, which is   
...
And also in first four types, one observes the symptoms of all humours.
	%TODO explain our change to sarvaliṅganidarśanam!!! SEE Mādhavanidāna  + Bhāvaprakāśa !!!! 
	% TILL HERE 
...
\item [19]
One should treat a \se{yoni}{female genital}  that is rough, cold, stiff and also 
insensible with \se{kumbhīsveda}{pot-sweat}%
	\footnote{%

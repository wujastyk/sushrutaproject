...
mentioned above (p.\pageref{wick}). %take up the end of passage 2 (line 6)
% in
...
versions say, “one should remove the wick”.\footnote{\dev{tatra
    ...
    \dev{tatra varttimupahṛtya} in Ḍalhaṇa's version (\Su{1.16.6}{77}).}  It
    ...
    day.\footnote{\As{6.1.58}{626} and \Ah{6.1.36}{780} respectively.} In

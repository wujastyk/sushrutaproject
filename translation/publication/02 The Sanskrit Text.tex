...
Furthermore, we speak of a single “version” because these manuscripts attest to a
...
that in spite of its Nepalese provenance, \MS{Kathmandu NAK
    1-1146},\footcite{rima-2022} does not support the “Nepalese version” and need not
...
premature.\footnote{For a list of known manuscript copies of the \SS, see the
    ...
    % witnesses as well.\q{I'm not sure of the intended meaning here. Is some
    % contrast
    % intended (i.e., although we believe that [...], many of the same features
    % are
...
\citep{vulgate}.\footnote{There are a few exceptions where Cakrapāṇidatta glossed
    ...
    books creates the misleading impression that both commentators had the same \SS\
    before them.\footnote{A similar situation exists with the edition of the
        \emph{Yogasūtravivaraṇa} by \citet{rama-1952} that is printed with the base text
        of the \emph{Pātañjalayogaśāstra} taken from \cite{agas-1904} which is not at all
        the same as that on which Śaṅkara was commenting \citep[77--78]{maas-2013}.}
        However, there is much evidence, including in SS.1.16 that is the topic of the
        present study, that this was not the case. For example, Ḍalhaṇa commented on four
        verses, \Su{1.16.11--14}{78}, as part of his root text, that Cakrapāṇidatta cited
        separately only in his commentary \citep[128--129]{acar-1939}. Cakrapāṇidatta had
        introduced each verse with “some people say” (\dev{kecitpaṭhanti}). This clearly
        indicated that these verses were not in the version of the \SS\ upon which he was
        commenting.  But a century or so later they had become part of the main text
        before Ḍalhaṇa. In spite of this, the editors \citeauthor{acar-1939} included them
        as if they had been part of the main text of the \SS\ that Cakrapāṇidatta was
        working with. Such cases make it hard to maintain clarity about the fact that
        these two important commentators were responding to different versions of the \SS.

Another example of these issues is the fact that Cakrapāṇidatta did not
acknowledge or comment on some verses that appear in the what we might call
“Ḍalhaṇa's version” of the \SS.  This is an \emph{argumentum ex silentio}.  After
all, it is possible that he may not have remarked on a verse because its meaning
was clear.  But in some cases, the commentarial convention of citing the first
words of a new verse or passage provides firmer ground for suspecting the absence
of a verse in the root text. To give an example, there is a prose passage at
Su.1.16.18 of the \SS\ that Cakrapāṇidatta commented on in his \emph{Bhānumatī}
(Fig.\,\ref{fig:yavasva}, left).\footnote{\cite[130]{acar-1939}, i.e.,
    ...
    the content of the prose passage.\footnote{Su.1.16.19--23 in \cite{acar-1939},
        ...
        \ldots}, \dev{vaddha \ldots}.} %\q{You say, “Both Cakrapāṇidatta and Ḍalhaṇa
...
was before him.\footnote{\Su{1.16.19--23}{79--80}.} However, Cakrapāṇidatta's
    older commentary showed no awareness of the first few verses in this group,
    ...
    the \SS\ known to him. Incidentally, the editors remarked in a footnote that verses
        20--21a were not in the Nepalese manuscript that they consulted showing that  
        Cakrapāṇi's version of the \SS\ is similar to the Nepalese version in this particular 
        case.\footcite[130,
        n.\,2]{acar-1939}
...
The manuscript on which the editors' edition of the \emph{Bhānumatī} was mainly
based,  \MScite{London BL H. T. Colebrooke 908}, does not include the root text of
the \SS.\footnote{This observation is based on an examination of the opening
    passage \MScite{London BL H. T. Colebrooke 908}. The MS is described in
    \volcite{1.5}[928, \#2647]{egge-1887}. %of MS 1887-1935
    ...
    careful reading of the commentary itself to infer what its author,
    Cakrapāṇidatta, was seeing in the manuscripts of the \SS\ that he had before
    him in the eleventh century. But, to summarize, there is no evidence that they
...
In fact, there is some evidence that Cakrapāṇidatta's version of the \SS\ was more
similar to the older Nepalese version than to the later version of Ḍalhaṇa. For
example, \SS\,1.16.5 of the Nepalese version begins with the compound
\dev{doṣasamudayāt}, and Cakrapāṇidatta began his comment on this passage by
glossing this same expression. Ḍalhaṇa's version, by contrast, inserted two
compounds, \dev{kliṣṭajihmāpraśastasūcīvyadhāt} and \dev{gāḍhataravartitvāt},
before this.\footnote{\SS\ \Su{1.16.6}{77}.} It appears that Cakrapāṇidatta was
    not aware of the compounds that Ḍalhaṇa saw in his later version, but was indeed
    reading a text similar to the Nepalese version.\footnote{\SS\,1.16.5
        \citep[126–127]{acar-1939}.}
        
If one looks beyond \SS\,1.16, there are other instances where the Nepalese version and
...
the reading commented on by Cakrapāṇidatta.\footnote{\SS\ 1.1.20 (\emph{sic})
    \citep[17]{acar-1939}.} However, Ḍalhaṇa commented on \dev{asmiñchāstre} and
    stated that “others read \dev{tatrāsmiñchāstre}”.\footnote{\SS\ \Su{1.1.22}{5}.}
        ...
        Another example is the reading of \dev{ṣaṣṭyā vidhānaiḥ} in Ḍalhaṇa's
        commentary on \Su{1.1.8.1}{3} that is not in his main text but that he
        ascribes to “some others.” This reading is likely to be derived  from the
        expression \dev{ṣaṣṭyābhidhānaiḥ} in the main text of the Nepalese version,
...
\citeauthor{kleb-2021b} has listed differences in the chapter sequence as they
...
Klebanov too has contributed some general remarks and examples of substantive
...
list, that of the bodily winds (\dev{prāṇa}, \SS\ 3.4). This  discussion  too
relied upon Gayadāsa's learned remarks. He commented on a version of the \SS\
corresponding to the Nepalese version and reported an alternative reading and its
interpretation preferred by another ancient commentator, Jejjaṭa.  It is precisely
Jejjaṭa's reading that is known to modern readers of the \SS\ from the vulgate
version of the text.
...
came from, namely the medical theory associated with the \emph{Carakasaṃhitā}.

As the present study demonstrates, many distinct features pertaining to the actual
...
other textual features, such as the text-structuring colophons concluding every
...
original.  Each case has to be weighed.

The following detailed comparison of 1.16 of the Nepalese version with Ḍalhaṇa's
\emph{Nibandhasaṅgraha} unfolded as the chapter was edited. The differences appear
to emanate largely from attempts to standardise, simplify or clarify the language
of the Nepalese version, add and redact information, and introduce changes to
recipes and treatments. Examples from 1.16 have been provided to demonstrate the
general observations which, it is hoped, will be supported by a larger survey of
the text.
...
parentheses.\footnote{Ācārya (\cite[80]{vulgate}) did not state that these verses
    ...
    137-3(b)}.}  Be this as it may, this large block of verses is absent in the
    Nepalese version.
\begin{figure}[t]
\centering
...
involved many small, yet sometimes significant, changes that are summarised
...
standardising of spelling,\footnote{For example, \dev{pattāṅga} (SS.1.16.21) →
    ...
    footnote \ref{pattanga} to the translation.} sandhi,\footnote{or example,
...
\dev{sandhāna} and \dev{sandhi} with \dev{bandha} in prose passages.\footnote{For
    ...
    of making such a change. Also, the names of joins which incorporate \dev{sandhāna}
...
an anointment that should be applied to a pierced ear that has not healed. In
Ḍalhaṇa's version (1.16.7, \cite[77]{vulgate}) the recipe was rewritten to include
sesame
seeds.\footnote{\dev{yavamadhukamañjiṣṭhāgandharvahastamūlairmadhughṛtapragāḍhairālepayet}
 (SS.1.16.5) → 
\dev{madhukairaṇḍamūlamañjiṣṭhāyavatilakalkairmadhughṛtapragāḍhairālepayet} 
(1.16.7, \cite[77]{vulgate}).} A more significant change occurs in another recipe for an 
admixture of an oil that is supposed to be rubbed into a healthy ear to enlarge it. 
Ḍalhaṇa's version (1.16.7, \cite[77]{vulgate}) of the admixture has five additional 
ingredients, namely, \se{apāmārga}{prickly chaff-flower}, \se{aśvagandhā}{Withania}, 
\se{kṣīraśuklā}{giant potato}, \se{madhuravarga}{ the `sweet' savour}\footnote{The 
items which exemplify the `sweet' savour \label{kakolyadi} (\dev{madhuravarga}) are 
enumerated at SS.1.42.11.} and `milk flower' (\dev{payasyā} $\rightarrow$ 
\dev{vidāri}\footnote{Pueraria tuberosa (Willd.) DC. (ADPS 510, IMP 1.792f., AVS 4.391; 
not Dymock 1.424f. See GJM supplement 444, 451, IMP 1.187, but IMP 3.1719 = Ipmoea 
mauritiana, Jacq.). }). It also has \se{vidārigandhā}{beggarweed} instead of 
\se{vidāri}{milk 
flower}.\footnote{\dev{arkālarkabalātibalānantāvidārīmadhukajalaśūkaprativāpantailampācayitvā}
 (SS.1.16.14) → 
\dev{arkālarkabalātibalānantāpāmārgāśvagandhāvidārigandhākṣīraśuklājalaśūkamadhuravargapayasyāprativāpaṃ
 tailamvā pācayitvā} (1.16.19, \cite[79]{vulgate}).} This method of redacting a recipe of 
Nepalese version appears to be somewhat typical in so far as most of the ingredients of 
the original were retained and new ones simply added. \q{Perhaps, Dr Madhu could add 
a comment on whether these additional ingredients would change the effects of the 
...
First, let us take up \Su{1.16.3}{76}, i.e., passage 2 in the edition of the
Nepalese version below. %Page 23, paragraph 1
%Dalhaṇa’s version supplementing material anticipating the instructions of the
%Nepalese version).
Although the Nepalese version does not present the reading \dev{picuvartiṃ
    praveśayet}, which Ḍalhaṇa’s version supports, it is interesting to note that the
reading \dev{tatra varttiṃ apahṛtya} in \SS\,\Su{1.16.15}{78}, Nepalese 10,  is
shared by both Nepalese and Ḍalhaṇa’s versions.\q{I'm puzzled. First, the phrase
    is in \Su{1.16.6}{77}, not 15, and then it's \dev{tatra vartimupahṛtya} not
    \dev{-apahṛtya}. See the variant readings to first page, line 10 of our edition. 
    Please clarify.}

Both \AS\,\As{6.1.57}{626} and \AHS\,\Ah{6.1.35}{780} describe inserting a thread
in the pierced earlobe and replacing it every third day.\footnote{\As{6.1.58}{626}
    and \Ah{6.1.36}{780}.}\q{emended Utt 1.48 to 1.58} %Utt 1.48 and \AHS\ Utt 1.36).
...
\AS\,\As{6.1.63}{626}, but the same is not present in \AHS.

As pointed out in the article, Ḍalhaṇa’s version adds a paste of sesame seeds
...
one of them,\footnote{\MScite{Mumbai, Asiatic Society 162}, catalogue no.\,BD 
...
% got to here.
Since the  paste of sesame seeds (\dev{tilakalka})  is the main differentiating

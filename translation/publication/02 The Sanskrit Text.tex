...
commentary.\footnote{\cite[78]{vulgate} and \cite[128--129]{acar-1939}
    ...
    (\dev{kecitpaṭhanti}). This clearly indicated that these verses were not in the
...
A similar clarification occurs in 1.16.18 of Ḍalhaṇa's version (\cite[79]{vulgate}), which 
reiterates the cure for an ear tainted by a humour that was described in 1.16.7 (= SS 
1.16.6). The reiteration is quite apt because it follows a passage  (1.16.17, 
\cite[79]{vulgate} = SS 1.16.12) that outlines the various symptoms of ear disease 
arising from each of the three humours. The author of the Nepalese version probably 
assumed that, after reading SS 1.16.12, the reader would refer back to SS 1.16.6 for the 
cure of an ear affected by a humour. However, in Ḍalhaṇa's version, the treatment is 
reiterated at 1.16.18.
...
ingredients, namely, \gls{apāmārga}, \gls{aśvagandhā}, \gls{kṣīraśuklā},  
\gls{madhuravarga}\label{kakolyadi} and \gls{payasyā}. %\footnote{The
    %items which exemplify the `sweet' savour \label{kakolyadi} (\dev{madhuravarga})
    % are
    %enumerated at SS 1.42.11.} and \gls{payasyā}. (\dev{payasyā} $\rightarrow$
    %\dev{vidāri}\footnote{Pueraria tuberosa (Willd.) DC. (ADPS 510, IMP 1.792f., AVS
    %4.391;
    %not Dymock 1.424f. See GJM supplement 444, 451, IMP 1.187, but IMP 3.1719 =
    %Ipmoea
    %mauritiana, Jacq.). }).
    It also has \gls{vidārigandhā} instead of
    \gls{vidārī}.\footnote{\dev{arkālarkabalātibalānantāvidārīmadhukajalaśūkaprativāpantailampācayitvā}
     (SS 1.16.14) → 
    \dev{arkālarkabalātibalānantāpāmārgāśvagandhāvidārigandhākṣīraśuklājalaśūkamadhuravargapayasyāprativāpaṃ
     tailamvā pācayitvā} (1.16.19, \cite[79]{vulgate}).} 
     
 The general tendency in redacting a recipe from the Nepalese version was to
...
version below, corresponding to SS \Su{1.16.3}{76} in Ḍalhaṇa's version. %Page 23,
% paragraph 1
The Nepalese version says nothing, while Ḍalhaṇa's version says “one should insert
a cloth wick” (\dev{picuvartiṃ praveśayet}).  A little later, both versions say,
“one should remove the wick”.\footnote{\dev{tatra varttimapahṛtya} in the Nepalese
    version (line 11), and the less clear \dev{tatra varttimupahṛtya} in Ḍalhaṇa's
    version (\Su{1.16.6}{77}).}  It looks as if the editor of Ḍalhaṇa's version put in
    the initial phrase about inserting the wick because it seemed logically
    to be lacking in the older Nepalese version.
%Although the Nepalese version does not present Ḍalhaṇa's reading \dev{picuvartiṃ
%    praveśayet}\,, it is interesting to note that the
...
%    Please clarify.}
Both the \AS\ and the \AHS\ describe first inserting a thread
in the pierced earlobe and then replacing it every third day.\footnote{\As{6.1.58}{626}
    and \Ah{6.1.36}{780} respectively.}
    %\q{emended Utt 1.48 to 1.58} %Utt 1.48 and \AHS\ Utt 1.36).
    In this repect, they agree  with Ḍalhaṇa’s version.

% got to here 2023-01-04

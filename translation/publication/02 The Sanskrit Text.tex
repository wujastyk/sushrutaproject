...
(\dev{tilakalka}), ghee (\dev{ghṛta}) and honey (\dev{madhu}) are not rare
...
specifically quoted as a healing recipe.\footnote{See, e.g., \SS\ \Su{1.11.22ab}{49}, 
\AS\ \As{1.38.21}{249--250} and \AHS\ \Ah{1.30.34}{357}.}

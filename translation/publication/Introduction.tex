...
cryptically that a rather different version of the text, cast in \dev{śloka}
...
professional competence of physicians (\dev{vaidya}) to that of barber-surgeons
(\dev{ambaṣṭha}s and others)?  Or perhaps the influence was in

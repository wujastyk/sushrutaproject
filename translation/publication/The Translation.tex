...
\se{pravardhanaka}{dilator} in order to enlarge it enough.\footnote{Cakrapāṇidatta
    ...
    \se{kārpāsa}{cotton plant}. Ḍalhaṇa added that it can also be made of
...
\item[\mdseries``Rim-join'' (\dev{nemīsandhānaka}):]
        both flaps are wide, long, and equal.
        
\item[\mdseries``Lotus-splittable'' (\dev{utpalabhedyaka}):]
        both flaps are round, long, and equal.
        
\item[\mdseries``Dried flesh'' (\dev{vallūraka}):]
        both flaps are short, round, and equal.
        
\item[\mdseries``Fastening'' (\dev{āsaṅgima}):]
        one flap is longer on the inside.
        
\item[\mdseries``Cheek-ear'' (\dev{gaṇḍakarṇa}):]
...
\item[\mdseries``Take-away'' (\dev{āhārya}):]
        the flaps are missing, in fact, on both sides.
        
\item[\mdseries``Ready-split'' (\dev{nirvedhima}):]
        the flaps are like a \se{pīṭha}{dais}.
        
\item[\mdseries``Multi-joins'' (\dev{vyāyojima}):]
        one flap is small, the other thick, one flap is equal, the other unequal.
        
\item[\mdseries``Door-hinge'' (\dev{kapāṭasandhika}):]
        the flap on the inside is long, the other is small.
        
\item[\mdseries``Half door-hinge'' (\dev{ardhakapāṭasandhika}):]
...
thin.\footnote{1.16.17 of Ḍalhaṇa's version \citep[79]{vulgate} reads “impure” for
    ...
    and itchy.  It has excessively copious \se{srāva}{suppuration} and is \se{śopha}{puffed
        up}.  It has a small amount of \se{kṣīṇa}{wasted} flesh and it will
    not grow.\footnote{In his edition of \emph{Suśrutasaṃhitā}, Ācārya \citep[79 n.
        ...
        the cotton bandage after three days' (\dev{āmatailena trirātraṃ pariṣecayet
...
\se{ānūpaudaka}{creatures that live in marshes or water},\footnote{For such
    classifications, see \citet{zimm-1999} and \citet{smit-1994}.} fat, marrow, milk,
    and sesame oil, and white mustard oil.\footnote{Ḍalhaṇa's version of \Su{1.16.19}{79}
        includes \se{sarpis}{ghee}. However, Ḍalhaṇa's remarks on this passage and
        ...
        with an \se{prativāpa}{admixture} of the following: \se{arka}{purple calotropis},
...
\item[17]
    ...
    \se{yojayed}{may repair} them.\footnote{After verse 17, the 1938 edition of Ācārya 

...
physician sits the boy, who has \se{kṛtamaṅgala}{received a benediction} --
\se{svastivācana}{blessings pronounced}\footnote{The syntax here is unclear.
...
\Su{1.16.3}{76}, the toys include replica elephants, horses, bulls and
...
salve} (\cite[81]{vulgate}).}\q{añjana}
    ...
    smooth.\footnote{Ḍalhaṇa  accepted a verse following this, which points out that 
    the procedure for joining the nose is similar to that of joining the lips without 
    fusing the ducts \citep[81]{vulgate}. He noted that earlier teachers did not think 
    ...
    it was accepted by Jejjaṭa, Gayadāsa and others. However, Cakrapāṇidatta 
     did not comment on this additional verse, which 

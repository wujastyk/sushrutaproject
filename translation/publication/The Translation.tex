...
received a benediction and the recitation of a blessing,\footnote{The causative form 
\emph{vy\u adhayet} is known in Classical
...
The
syntax of this slightly long sentence is unusual in beginning with the dual object
\emph{tau} “the two (ears)” at the start of the sentence, which is remote from the
main verb.  The other singular accusatives referring to the ear being pierced are
governed by absolutives.} For a boy, do the right ear first; for a girl, do the
left one. Use a needle on a thin ear; an \se{ārā}{awl} on a thick
...
386]{meul-hist}.}
    ...
    in the wrong place.\q{Excess blood or pain are signs that it was pierced in the wrong 
    place.} The absence of side-effects is a sign that it has been pierced 
...
and burning.'}
    ...
    \item[5]     Having removed the \se{varti}{wick} in the hole because of the
accumulation of humours or an unsatisfactory piercing,\footnote{In addition to these
reasons, 1.16.6 of Ḍalhaṇa at \Su{1.16.6}{77}, added
\emph{kliṣṭajihmāpraśastasūcīvyadhāt} (“because of piercing with a painful,
crooked and unsatisfactory needle”) and \emph{gāḍhataravartitvāt} (“because of
a wick that is too thick”). Ḍalhaṇa was aware of the reading in the Nepalese
version because he noted in his commentary on \Su{1.16.6}{77} that some read
“because of the accummulation of humours” rather than “because of piercing
with a painful, crooked and unsatisfactory needle or because of a wick that is
too thick.” On the meaning of \se{samudāya}{accumulation}, see the important 
analysis by \citet{meul-1992}.}\q{Add a second reference in the fn for the article on 
samudāya; Andrey's idea?}
...
again.
    ...
    \item[6] One should treat the properly-pierced ear by sprinkling it with unrefined\q{āma? 
    virgin?} 
    sesame
    ...
    loosen it with a light \se{pravardhanaka}{dilator} in order to enlarge 
...
qualified attendants, one considers the \se{bandha}{joins} and then applies
them by means of \se{chedya}{cutting}, \se{bhedya}{splitting},
\se{lekhya}{scarification}, or \se{vyadhana}{piercing}.\footnote{There are 
syntactic difficulties 
in this sentence.  We have 
%    It appears that a verb has
...
\se{vadhra}{slice of flesh} should then be trimmed. If it is 
\se{hīna}{reduced}, however, one should make an effort to stretch it, and one
should make its overgrown flesh smooth.\footnote{Ḍalhaṇa  accepted a verse
following this, \Su{1.16.32}{81}, which points out that the procedure for

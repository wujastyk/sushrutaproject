...
\se{kṛtamaṅgala}{received a benediction} -- \se{svastivācana}{blessings
    pronounced}\footnote{The syntax here is unclear. The expression
...
are united in a compound that reads more naturally.} --, on the lap of a wet-nurse
and pacifies him.\footnote{The versions of 1.16.3 known to Cakrapāṇidatta
...
special treats”) before \emph{bālakrīḍanakaiḥ}, but we see no trace of this in our
...
\se{ārā}{awl} on a thick one.\footnote{Ḍalhaṇa on 1.16.3 \citep[76]{vulgate}
...
\cite[1–5]{meul-1992}.}\q{Add reference in the fn for the article on samudāya}

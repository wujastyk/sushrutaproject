...
\begin{description}
    ...
    \begin{figure}[t]
        \centering
        \includegraphics[width=1\linewidth]{"../../../../../../Digitized MSS 
        extracts/Susrutasamhita/Kathmandu, Kaiser Shum Shere Library and NAK/MS KL 699 
        from Andrey Klebanov col/003v IMG_0123"}
        \caption{}
...
The diplomatic transcripts were uploaded to Li's manuscript collation platform
...
\begin{figure}[h]
    ...
    \label{SS.1.16}
\end{figure}
\q{Pick a new example}
For example, as seen in Figure~\ref{SS.1.16}, the apparatus for the words 
\dev{bahutve 'tivedanāyāṃ} is on the right side of the display. 
This entry means that the editors have chosen to read 
\dev{bahutve 'tivedanāyāṃ}, which is the reading of K, whereas A has 
\dev{°bahutvena nivedanayā}, N \dev{°bahutveti vedanāś} and H 
\dev{°bahutvanivedanāyāc}. The final \dev{c} in the reading of H is italicised 
...
\dev{°bahutvanivedanāyāṃ} appears in a pop-up window in which the lemma and

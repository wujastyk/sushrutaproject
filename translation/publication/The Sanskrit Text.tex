...
\emph{gāḍhataravartitvāt}, before this.\footnote{\SS\ \Su{1.16.6}{77}.} Cakrapāṇidatta
...
%Ḍalhaṇa notes the variant reading \emph{ṣaṣṭyā vidhānaiḥ}, which is not in his
% root
...
Cikitsāsthāna.\footnote{\Su{2.6}{289--294} and 
...
to replace uncommon words with generic ones,\footnote{For example, \emph{mrakṣayet} 
...
\emph{sandhi} with \emph{bandha} in prose passages.\footnote{For example,
    ...
    \Su{1.16.10}{77}); \emph{daśakarṇasandhivikalpāḥ} (SS.1.16.9) →
...
The Nepalese version contains the rather obscure term \emph{vadhra} for the slice
...
adjectives and adverbs were inserted to clarify statements,\footnote{For example,
    \emph{chidre} (\SuComma{1.16.2}{76}) → \emph{chidra ādityakarāvabhāsite}
    (\SuComma{1.16.3}{76}); [absent] (1.16.2) → \emph{śanaiḥ śanaiḥ} (1.16.3); 
    [absent] (SS.1.16.3) → \emph{āśu} (\SuComma{1.16.5}{77}).} and phrases added to
    elaborate on diseases and treatments.\footnote{For example, \emph{dhātryaṅke}
        ...
        characteristics,\footnote{For example, \emph{pīṭhopamapālir nirvedhimaḥ}
            ...
            nirvedhimaḥ} (\SuComma{1.16.10}{77}); \emph{itarālpapāliḥ saṃkṣiptaḥ} 
            (SS.1.16.9)

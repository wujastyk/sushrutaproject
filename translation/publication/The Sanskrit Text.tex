...
In the present article and other publications of our research group, we focus on the study of what we call the "Nepalese version" of the Suśrutasaṃhitā. Given the conceptual significance of this term and the frequency with which it appears in our papers, we consider it necessary to explain in what sense it is (and in what sense it is not) used here.%
    \footnote{%
    Many arguments in this section derive from the discussion in \citet[2-3]{kleb-2021b}.%
    } 
Put plainly, the term "Nepalese version of the \SS" refers to a hypothetical version of the compendium reconstructed critically-historically based on the evidence of three Nepalese manuscripts, which were briefly introduced above and which will be described in more detail in a later section.  We call these MSS "Nepalese" not just because they were preserved and discovered to the modern readership in the present-day Kathmandu valley, but because they are written in a specific variety of Indic scripts, which, to the best of our knowledge, was not used outside of the region, and hence, they were most likely produced in the same area as well. \citet{hari-2011}, \citet{wuja-2013}, \citet{kleb-2021b}, as well as the present study, demonstrate that all three manuscripts transmit a highly uniform text, which, however, can be sharply distinguished from all other textual wittnesses available to us by a significant number of characteristic features.

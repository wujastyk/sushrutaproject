...
hand,  inserts two compounds, \dev{kliṣṭajihmāpraśastasūcīvyadhāt} and
\dev{gāḍhataravartitvāt}, before this.\footnote{\Su{1.16.6}{77}.} Cakrapāṇidatta
...
the Nepalese version has \dev{tatrāsmiñchāstre}, which is also the reading
...
on \dev{asmiñ chāstre} and states that “others read \dev{tatrāsmiñ
    chāstre}”.\footnote{\Su{1.1.22}{5}.} %Also, in his commentary on SS.1.1.8.1,
...
\emph{cikitsāsthāna}~12. %\q{You could save repetition by placing this sentence
% before 'The discussion of
%    the textual variant in the second case study [...] and change this sentence
% to
%    'The discussion of the textual variant in the list of vital energies also
%    recourses [...]}
...
commentator, Gayadāsa (fl.\,ca.\,1000), who %\q{do you mean to say that Gayadāsa
% has text-external evidence? That how
%    it sounds. Perhaps, omit the phrase.}
...
by another ancient commentator, Jejjaṭa. It is precisely this\q{the referent of
    this is not so clear. 'this alternative reading'?} reading that is known to modern
...
Apart from adding whole passages and verses (as seen in Table 1), redactors of subsequent 
...
to clarify statements,\footnote{For example, \emph{chidre} (\SuComma{1.16.2}{76}) → 
\emph{chidra ādityakarāvabhāsite} (\SuComma{1.16.3}{76}); [absent] 
(1.16.2) 
→ 
\emph{śanaiḥ śanaiḥ} (1.16.3);  [absent] (SS.1.16.3) → \emph{āśu} 
(\SuComma{1.16.5}{77}).} and phrases added to elaborate on diseases and 
...
(\SuComma{1.16.9}{77}) → \emph{pīṭhopamapālir ubhayataḥ kṣīṇaputrikāśrito 
nirvedhimaḥ} (\SuComma{1.16.10}{77}); \emph{itarālpapāliḥ saṃkṣiptaḥ} (SS.1.16.9) → 
\emph{utsannapālir 
...
the symptoms mentioned.\footnote{In Ḍalhaṇa's version  (\SuComma{1.16.5}{76–77}), the 
symptoms of \se{jvara}{fever} and \se{vedanā}{pain} are repeated. This repetition does 

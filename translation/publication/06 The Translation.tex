...
\addtocounter{chapter}{1}
 \chapter{Translation of Sūtrasthāna 16}
...
One should gather as much as one can the following: a \seEngOnly{godhā}{monitor
    lizard}, %{godhā}{Varanus bengalensis, Schneider}{Daniel 1983:58},
...
\seEngOnly{ānūpaudaka}{creatures that live in marshes or water},\footnote{For such
    ...
    fat, marrow, milk, and sesame oil, and white mustard oil.\footnote{Ḍalhaṇa's
        version of \Su{1.16.19}{79} includes \seEngOnly{sarpis}{ghee}. However, 
        Ḍalhaṇa's
        ...
        say it is made with four oils and milk.}\q{think more about the compound structure
            here?} Then cook the oil with an \seEngOnly{prativāpa}{admixture} of the
...
\item[17]
    ...
    Ācārya \citep[80]{vulgate} has in parentheses nineteen verses on diseases of the ear 
    lobes,  treatments and complications. It is possible that these verses were in some of 
    the witnesses used by Ācārya to construct the text as they occur in other manuscripts, 
    such as  \MScite{Hyderabad Osmania 137-3(b)}. However, Cakrapāṇidatta 
    \citep[132]{acar-1939} and 
    Ḍalhaṇa \citep[80]{vulgate} stated that some read about the diseases of the ear 
    lobes in 
    ...
    discussion of the disease \dev{paripoṭa}.  Ḍalhaṇa went on to say that some believe 
...
\item[18]
    ...
    even, well-healed, and free from pain, then one can enlarge it slowly.\footnote{The 
    order of verses 17 and 18 is reversed in Ḍalhaṇa's version \citep[80]{vulgate}.}
        \end{sloka}
...
\begin{sloka}
    ...
    to its original site on the cheek. However, Ḍalhaṇa \citep[81]{vulgate} clarified the 
    meaning of the vulgate here by stating that one should supply the word “flesh” when 
    reading “connected,” thus indicating that he understood the flesh to be connected to 
    the face.} % 
%
...
it along with two tubes.\footnote{Ḍalhaṇa noted that the two tubes should be made
    ...
    castor oil plant} (on \Su{1.16.21}{81}). They should not be made of lead or betel nut 
    because
    ...
    raised,\footnote{The Sanskrit term \dev{unnāmayitvā} in 1.16.21 is non-Pāṇinian.}
        ...
        L. %(AVS
            ...
            and Indian barberry.\footnote{Berberis aristata, DC. % (Dymock 1.65, NK 
                % \#685, GJM 562, IGP 141).
                Ḍalhaṇa understood it as \se{rasāñjana}{elixir salve}
...
And once healed and really come together, what is left of that \se{vadhra}{slice
    ...
    smooth.\footnote{Ḍalhaṇa accepted a verse following this, \Su{1.16.32}{81}, which
        pointed out that the procedure for joining the nose is similar to that of joining

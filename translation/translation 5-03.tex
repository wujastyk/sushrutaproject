...
For this reason, every poison is known to inflame all of the humours.

\item[26]

Inflamed and afflicted by the poison, they leave their natural functions.  Poison
does not get digested, so it blocks the breaths.
...
Their fangs are like hooks.  When it gets there, it sticks inside them. That is
why snakes do not release poison that has not been agitated.

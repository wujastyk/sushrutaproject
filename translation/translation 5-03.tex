...
One designates a person who has diarrhoea that is feces with wind like
\se{gṛhadhūma}{soot},\footnote{\dev{gṛhadhūma} is not a plant in this
    context \emph{pace} \cite[362]{moni-sans}.} and who vomits foam, as “someone
    who has drunk poison.”

\item[37]

Therefore, fire burns a heart that is pervaded by poison. For, having pervaded of its 
own accord  the location of 
consciousness, it abides.\q{Ḍalhaṇa said that the heart of someone who has died 
from drinking poison has a heart that cannot be burned because it is pervaded by 
poison (\Su{5.3.37}{570}).}
...
dawn or dusk, at a crossroads, in Yama's direction,\footnote{\dev{yāmye} means
    ...
    people who have been bitten in the lethal spots.
...
a knife, where streaks do not appear by lashes,\footnote{Ḍalhaṇa, on
    \Su{5.3.40}{570}, glossed \dev{latābhis} “by means of whips,” as “when the
    body is struck by whips.”} %
    or where there is no horripilation because of cold water, \dag\ whose tongue
    is a mouth, whose hair is falling out, whose \dag nose\dag is exhausted and

...
\item[2] 
\begin{itemize}
    \item Creatures with poison in their breath and gaze: snakes in heaven;
    ...
    \se{nara}{men},\q{check MSS} crocodiles, frogs, 
    \se{pākamatsya}{cook-fish},\q{check Ḍalhaṇa} monitor lizards, 
    \se{śambuka}{Shambuka},\q{?} 
    \se{pracalāka}{Prachalaka},\q{?}
    \se{gṛhagodhikā}{house lizard},\q{? and check reading of K; ñ ->ś}
    and four-footed insects and others. 
% got to here
\end{itemize}
...
poisons, that have been mentioned by me in brief, will be stated.\footnote{
    “Carrier” for \se{adhiṣṭhāna}{base, foundation} tries to capture the idea that the
...
The arrogant demon called Kaiṭabha created an obstacle for lotus-born Brahmā, at
the very time that he was creating these creatures.
